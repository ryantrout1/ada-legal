  ...
  if (loading) {
    return (
      <div role="status" aria-label="Loading your cases" style={{
        ...
        <h1 style={{ position: 'absolute', width: '1px', height: '1px', padding: 0, margin: '-1px', overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>Attorney Dashboard</h1>
