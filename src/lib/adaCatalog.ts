...
export const ADA_CATALOG: AdaStandardRow[] = [
  ...
  { section: '§307', chapter: 3, title: 'Protruding Objects', fixture: 'route', rule: 'Objects with leading edges between 27 and 80 in above the floor may protrude 4 in max into circulation paths; post-mounted objects 12 in max; provide 80 in min vertical clearance (307).', access_role: 'gating', photo_assessable: true, guide_slug: 'sidewalks', source_ref: CH3 },
  ...
  { section: '§403', chapter: 4, title: 'Walking Surfaces', fixture: 'route', rule: 'Walking surfaces on accessible routes: running slope 1:20 max, cross slope 1:48 max, clear width 36 in min (32 in at a point), with passing spaces on long narrow routes (403).', access_role: 'gating', photo_assessable: true, guide_slug: 'sidewalks', source_ref: CH4 },
  ...
  { section: '§705', chapter: 7, title: 'Detectable Warnings', fixture: 'detectable_warning', rule: 'Truncated-dome detectable warnings at transit platform boarding edges and where else required, with specified dome size and spacing and visual contrast (705).', access_role: 'component', photo_assessable: true, guide_slug: 'sidewalks', source_ref: CH7 },
