...
export const ADA_CATALOG: AdaStandardRow[] = [
  ...
  { section: '§705', chapter: 7, title: 'Detectable Warnings', fixture: 'detectable_warning', rule: 'Truncated-dome detectable warnings are required at transit platform boarding edges and at curb ramps and blended transitions in the public right-of-way; they are NOT required at typical interior or private-site ramps and curb cuts. Do not flag a missing or non-compliant detectable-warning surface where detectable warnings are not required at that location. Where required, check dome size, spacing, and visual contrast (705).', access_role: 'component', photo_assessable: true, guide_slug: 'sidewalks', source_ref: CH7 },
