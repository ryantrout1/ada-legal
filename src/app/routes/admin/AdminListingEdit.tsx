    ...
    <section>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-2xl">
        ...
        {!isNew && (
          <div className="rounded-md border border-surface-200 bg-surface-50 p-3 text-sm text-ink-700 flex items-center justify-between gap-3">
            <div>
              <strong className="text-ink-900">Preview with Ada</strong>
              <p className="text-xs text-ink-500 mt-1">
                Run a test conversation against this listing&rsquo;s config.
                No emails are sent, no transcripts saved.
              </p>
            </div>
            <Link
