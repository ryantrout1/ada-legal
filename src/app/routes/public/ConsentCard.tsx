  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="min-h-[44px] px-5 py-3 rounded-md bg-accent-500 text-[color:var(--page-bg)] font-medium hover:bg-accent-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-600 disabled:opacity-70 transition-colors"
      >
