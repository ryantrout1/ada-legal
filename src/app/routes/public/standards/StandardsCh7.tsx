...
const sections = [
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Room signs (like restroom signs and room numbers) need Braille and raised letters, mounted at 48 to 60 inches high.</li><li style={{marginBottom:"6px"}}>Directional signs need large, high-contrast text but don't need Braille.</li><li style={{marginBottom:"6px"}}>Look for: flat-printed room signs with no raised letters or Braille, signs mounted too high or on the door itself.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Fire alarms must have flashing strobe lights, not just sound, so deaf people are alerted.</li><li style={{marginBottom:"6px"}}>Strobes are needed in public areas, workspaces, and accessible hotel rooms.</li><li style={{marginBottom:"6px"}}>Look for: alarm systems with no visible flashing component.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Public phones (including hotel courtesy phones) must be reachable from a wheelchair — 48 inches max.</li><li style={{marginBottom:"6px"}}>They must have volume control and at least one text telephone (TTY) per bank.</li><li style={{marginBottom:"6px"}}>This applies to any phone provided for public use, not just pay phones.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>The bumpy pads at curb ramps and train platforms are called detectable warnings.</li><li style={{marginBottom:"6px"}}>They warn blind people that they're about to enter a street or rail area.</li><li style={{marginBottom:"6px"}}>They must contrast visually with the surrounding surface.</li><li style={{marginBottom:"6px"}}>Look for: missing bumpy pads at crosswalk ramps or platform edges.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Theaters, courtrooms, and meeting rooms must offer assistive listening devices (like hearing loops or FM receivers).</li><li style={{marginBottom:"6px"}}>At least 25% of devices must work with hearing aids.</li><li style={{marginBottom:"6px"}}>Signs must be posted showing the system is available.</li><li style={{marginBottom:"6px"}}>Look for: no assistive listening signs, no devices available upon request.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>ATMs and ticket machines must talk — they need speech output through a headphone jack for blind users.</li><li style={{marginBottom:"6px"}}>They need Braille instructions and a raised dot on the "5" key.</li><li style={{marginBottom:"6px"}}>All controls must be within 48 inches of the floor.</li><li style={{marginBottom:"6px"}}>Look for: ATMs with no headphone jack, kiosks with touchscreen-only controls, machines mounted too high.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Building intercoms and call boxes must work for deaf people — both audio and visual signals.</li><li style={{marginBottom:"6px"}}>The call button must be within reach (48 inches max) and usable without a handset.</li><li style={{marginBottom:"6px"}}>Look for: intercom systems that only work with voice, call buttons mounted too high.</li></ul></>,
