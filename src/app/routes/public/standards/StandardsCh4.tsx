...
const sections = [
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>There must be a clear, continuous path from the entrance to every part of the building a person needs to reach.</li><li style={{marginBottom:"6px"}}>This path must be at least 36 inches wide (about 3 feet).</li><li style={{marginBottom:"6px"}}>Look for: paths that are too narrow, blocked by furniture, or that end at stairs with no ramp or elevator.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Walking paths must be at least 36 inches wide, firm, and not too steep.</li><li style={{marginBottom:"6px"}}>A gentle slope (up to 1:20) is OK. Anything steeper becomes a ramp and needs handrails.</li><li style={{marginBottom:"6px"}}>The sideways tilt can't be more than about 2% — enough to cause a wheelchair to drift.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Doors must open wide enough for a wheelchair — at least 32 inches of clear space.</li><li style={{marginBottom:"6px"}}>Door handles must be lever-style (no round knobs) and take less than 5 lbs to open.</li><li style={{marginBottom:"6px"}}>The threshold (bump at the bottom) can't be more than ½ inch high.</li><li style={{marginBottom:"6px"}}>Look for: heavy doors, round knobs, high thresholds, not enough room to approach the door in a wheelchair.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Ramps can't be steeper than 1:12 — for every 1 inch up, 12 inches of ramp.</li><li style={{marginBottom:"6px"}}>Handrails are required on both sides if the ramp rises more than 6 inches.</li><li style={{marginBottom:"6px"}}>A flat landing is needed every 30 inches of rise and at every turn.</li><li style={{marginBottom:"6px"}}>Look for: ramps that are too steep, missing handrails, no flat resting areas.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Curb ramps let people in wheelchairs move between the sidewalk and street.</li><li style={{marginBottom:"6px"}}>They need bumpy pads (truncated domes) at the bottom to warn blind people they're entering the road.</li><li style={{marginBottom:"6px"}}>Look for: missing curb ramps at crosswalks, ramps without warning bumps, ramps that are too steep.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Elevator buttons must be no higher than 42 inches and have Braille labels.</li><li style={{marginBottom:"6px"}}>The elevator must announce floors with a chime and visual display.</li><li style={{marginBottom:"6px"}}>The cab must be big enough for a wheelchair — at least 51 × 68 inches for standard elevators.</li><li style={{marginBottom:"6px"}}>Look for: buttons too high to reach, no Braille, doors that close too fast.</li></ul></>,
  ...
  },
  {
    ...
    simple: <><ul style={{paddingLeft:"1.25rem",margin:0}}><li style={{marginBottom:"6px"}}>Platform lifts can be used instead of ramps in some cases (like stages or existing buildings).</li><li style={{marginBottom:"6px"}}>Stairs on accessible routes need handrails on both sides that extend past the top and bottom steps.</li><li style={{marginBottom:"6px"}}>Look for: missing handrails, handrails that end too short, lifts that are out of order.</li></ul></>,
