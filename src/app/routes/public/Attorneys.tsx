        ...
        <div className="flex flex-wrap gap-4 items-end">
          ...
          <label className="flex flex-col gap-1 text-sm">
            ...
            <select
              ...
              className="rounded-md border border-surface-200 bg-white px-3 py-2 text-ink-900 min-w-[120px]"
            >
          ...
          <label className="flex flex-col gap-1 text-sm">
            ...
            <input
              ...
              className="rounded-md border border-surface-200 bg-white px-3 py-2 text-ink-900 min-w-[180px] placeholder-ink-500"
            />
          </label>
