 ...
 *   - DASHBOARD and FEEDBACK are absent until M6 Phase 3 builds them.
 *     A nav entry pointing at a page that does not exist is worse than
 *     a missing entry — it reads as a broken tool rather than an
 *     unfinished one.
 *
