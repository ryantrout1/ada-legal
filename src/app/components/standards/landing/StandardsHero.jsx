/**
 * StandardsHero — ported from Base44 (src/components/standards/StandardsHero.jsx
...
const QUOTES = [
  ...
  {
    text: "I always figured a restaurant without a ramp was just how it was. Turns out there's a specific ADA standard for entrances \u2014 I found it in 30 seconds.",
    attribution: "The reason we built this"
  }
];
...
/**
 * @param {{ searchValue: string, onSearchChange: (value: string) => void }} props
 */
      ...
      <div className="sg-hero-grid">
        ...
        <div>
          ...
          <h1 id="sg-heading" style={{
            ...
            Know the law.<br />
            <span style={{ color: 'var(--accent-light)' }}>Know your rights.</span>
          </h1>
          ...
          <p style={{
            ...
            the built environment — reorganized by topic and written in plain
        ...
        <div>
          ...
          <div style={{
            ...
            <p style={{
              ...
              topics with plain-language explanations. Every citation links to the
              official DOJ text on ADA.gov.
            </p>
          </div>
