    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 320" role="group" aria-labelledby="tel-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="180" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">All controls within 48{'\u2033'} of floor</text>
          <text x="180" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">reach range for wheelchair users</text>
          <rect x="60" y="135" width="240" height="50" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="180" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">30{'\u2033'} {'\u00d7'} 48{'\u2033'} clear floor space</text>
          <text x="180" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">forward or parallel approach</text>
          <rect x="60" y="200" width="240" height="40" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="180" y="224" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Cord: 29{'\u2033'} minimum length</text>
          ...
          <text x="540" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Volume control: +12 dB minimum</text>
          <text x="540" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">up to +20 dB max amplification</text>
          <rect x="400" y="135" width="280" height="50" rx="10" fill="#C2410C" opacity="0.04" stroke="#C2410C" strokeWidth="1.5" />
          <text x="540" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">TTY required (1 per bank of 4+)</text>
          <text x="540" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">text telephone for deaf users, with shelf</text>
          <rect x="400" y="200" width="280" height="50" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="540" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Hearing-aid compatible</text>
          <text x="540" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">marked with TTY and volume symbols</text>
