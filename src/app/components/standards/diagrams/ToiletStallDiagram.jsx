  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Accessible Toilet Stall</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 400" role="img" aria-labelledby="ts-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="305" y="215" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="500">door</text>

          {/* Toilet */}
          <ellipse cx="120" cy="280" rx="22" ry="28" fill="#C2410C" opacity="0.06" stroke="#C2410C" strokeWidth="1.5" />
          <text x="120" y="284" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="600">toilet</text>

          {/* Side grab bar */}
          <line x1="55" y1="250" x2="55" y2="320" stroke="#15803D" strokeWidth="4" strokeLinecap="round" />
          <text x="40" y="288" textAnchor="end" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600" transform="rotate(-90 40 288)">side bar</text>

          {/* Rear grab bar */}
          <line x1="70" y1="325" x2="180" y2="325" stroke="#15803D" strokeWidth="4" strokeLinecap="round" />
          <text x="125" y="345" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">rear bar</text>
          ...
          <text x="175" y="383" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('60', '1525')} min wide</text>
          ...
          <text x="100" y="269" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('16', '405')}{'\u2013'}{d('18', '455')}</text>
          <text x="100" y="248" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="500">centerline</text>

          {/* Transfer space note */}
          <rect x="145" y="130" width="100" height="100" rx="4" fill="#2563EB" opacity="0.03" stroke="#2563EB" strokeWidth="1" strokeDasharray="4 3" />
          <text x="195" y="175" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">transfer</text>
          <text x="195" y="189" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">space</text>
          ...
          <text x="540" y="86" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Stall: {d('60', '1525')} wide, {d('56', '1420')}{'\u2013'}{d('59', '1500')} deep</text>
          <text x="540" y="103" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">depends on wall-mounted vs floor-mounted toilet</text>

          <rect x="400" y="125" width="280" height="48" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="540" y="146" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Toilet: {d('16', '405')}{'\u2013'}{d('18', '455')} from wall, seat {d('17', '430')}{'\u2013'}{d('19', '485')}</text>
          <text x="540" y="163" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">centerline to side wall; seat height above floor</text>

          <rect x="400" y="185" width="280" height="48" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="206" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Side bar: {d('42', '1065')} long, rear bar: {d('36', '915')} long</text>
          <text x="540" y="223" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">mounted {d('33', '840')}{'\u2013'}{d('36', '915')} above floor</text>

          <rect x="400" y="245" width="280" height="48" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="540" y="266" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Flush on open side, TP within reach</text>
          <text x="540" y="283" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">dispenser must not block the grab bar</text>

          <rect x="400" y="305" width="280" height="40" rx="10" fill="#B45309" opacity="0.04" stroke="#B45309" strokeWidth="1.5" />
          <text x="540" y="326" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#78350F" fontWeight="600">Door: self-closing, pulls both sides, swings out</text>
