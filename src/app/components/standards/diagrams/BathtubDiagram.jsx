  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Accessible Bathtub</h2>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="bt-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* LEFT: Plan view */}
          {/* Tub outline */}
          <rect x="40" y="80" width="250" height="120" rx="6" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="2" />
          <text x="165" y="145" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">bathtub</text>
          {/* Seat */}
          <rect x="40" y="80" width="50" height="120" rx="4" fill="var(--dx-violet)" opacity="0.06" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="65" y="145" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="600">seat</text>
          {/* Controls on opposite end */}
          <rect x="270" y="120" width="16" height="16" rx="3" fill="var(--dx-green)" opacity="0.2" stroke="var(--dx-green)" strokeWidth="1" />
          <text x="295" y="118" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">controls</text>
          {/* Grab bars (back wall) */}
          <line x1="50" y1="77" x2="280" y2="77" stroke="var(--dx-green)" strokeWidth="3" strokeLinecap="round" />
          <text x="165" y="70" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">back wall grab bar</text>
          {/* Clear floor space */}
          <rect x="40" y="210" width="250" height="60" rx="2" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1" strokeDasharray="4 3" />
          <text x="165" y="240" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">30{'\u2033'}{'\u00d7'}60{'\u2033'} clear floor space</text>
          <text x="165" y="256" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">full length of tub</text>
          {/* Shower hose note */}
          <rect x="40" y="280" width="220" height="22" rx="6" fill="var(--dx-amber)" opacity="0.06" stroke="var(--dx-amber)" strokeWidth="1" />
          <text x="150" y="295" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)" fontWeight="600">hand-held spray: 59{'\u2033'} hose min</text>

          {/* DIVIDER */}
          <line x1="360" y1="40" x2="360" y2="320" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT */}
          <rect x="400" y="60" width="280" height="48" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="540" y="81" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">30{'\u2033'}{'\u00d7'}60{'\u2033'} clear floor alongside tub</text>
          <text x="540" y="98" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">must extend the full tub length</text>
          <rect x="400" y="120" width="280" height="48" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="540" y="141" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">Seat at head end: {d('15', '380')} deep min</text>
          <text x="540" y="158" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">permanent or removable</text>
          <rect x="400" y="180" width="280" height="48" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="201" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Grab bars on back wall + head end</text>
          <text x="540" y="218" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">{d('33', '840')}{'\u2013'}{d('36', '915')} high, plus lower bar at rim</text>
          <rect x="400" y="240" width="280" height="48" rx="10" fill="var(--dx-amber)" opacity="0.04" stroke="var(--dx-amber)" strokeWidth="1.5" />
          <text x="540" y="261" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-amber)" fontWeight="600">Hand-held spray: 59{'\u2033'} hose minimum</text>
          <text x="540" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)">must work as both fixed and hand-held</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Bathtubs</p>
        <KeyFact color="var(--dx-orange)" number={`30\u2033\u00d760\u2033`}>Clear floor space alongside full tub length</KeyFact>
        <KeyFact color="var(--dx-violet)" number={d('15', '380')}>Minimum seat depth at head end</KeyFact>
        <KeyFact color="var(--dx-amber)" number={d('59', '1500')}>Minimum shower hose length</KeyFact>
      </div>
      <style>{`
