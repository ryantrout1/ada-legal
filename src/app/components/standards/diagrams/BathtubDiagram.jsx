    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="bt-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="165" y="145" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#C2410C" fontWeight="600">bathtub</text>
          {/* Seat */}
          <rect x="40" y="80" width="50" height="120" rx="4" fill="#7C3AED" opacity="0.06" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="65" y="145" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="600">seat</text>
          {/* Controls on opposite end */}
          <rect x="270" y="120" width="16" height="16" rx="3" fill="#15803D" opacity="0.2" stroke="#15803D" strokeWidth="1" />
          <text x="295" y="118" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">controls</text>
          {/* Grab bars (back wall) */}
          <line x1="50" y1="77" x2="280" y2="77" stroke="#15803D" strokeWidth="3" strokeLinecap="round" />
          <text x="165" y="70" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">back wall grab bar</text>
          {/* Clear floor space */}
          <rect x="40" y="210" width="250" height="60" rx="2" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1" strokeDasharray="4 3" />
          <text x="165" y="240" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">30{'\u2033'}{'\u00d7'}60{'\u2033'} clear floor space</text>
          <text x="165" y="256" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">full length of tub</text>
          {/* Shower hose note */}
          <rect x="40" y="280" width="220" height="22" rx="6" fill="#B45309" opacity="0.06" stroke="#B45309" strokeWidth="1" />
          <text x="150" y="295" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F" fontWeight="600">hand-held spray: 59{'\u2033'} hose min</text>
          ...
          <text x="540" y="81" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">30{'\u2033'}{'\u00d7'}60{'\u2033'} clear floor alongside tub</text>
          <text x="540" y="98" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">must extend the full tub length</text>
          <rect x="400" y="120" width="280" height="48" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="540" y="141" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Seat at head end: {d('15', '380')} deep min</text>
          <text x="540" y="158" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">permanent or removable</text>
          <rect x="400" y="180" width="280" height="48" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="201" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Grab bars on back wall + head end</text>
          <text x="540" y="218" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">{d('33', '840')}{'\u2013'}{d('36', '915')} high, plus lower bar at rim</text>
          <rect x="400" y="240" width="280" height="48" rx="10" fill="#B45309" opacity="0.04" stroke="#B45309" strokeWidth="1.5" />
          <text x="540" y="261" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#78350F" fontWeight="600">Hand-held spray: 59{'\u2033'} hose minimum</text>
          <text x="540" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F">must work as both fixed and hand-held</text>
