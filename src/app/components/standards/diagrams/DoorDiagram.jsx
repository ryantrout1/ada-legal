    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="img" aria-labelledby="door-open-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="190" y="116" fontFamily="var(--font-body)" fontSize="10" fill="#94A3B8">90{'\u00b0'}</text>
          ...
          <text x="186" y="183" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="white">{d('32', '815')} min</text>
          ...
          <text x="170" y="296" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">approaching</text>
          ...
          <text x="535" y="106" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#14532D">{'\u2264'} 5 lbs to push open</text>
          <text x="535" y="124" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">interior doors (fire doors follow fire code)</text>

          <rect x="395" y="160" width="280" height="60" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="535" y="186" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#1E3A8A">5 seconds to close</text>
          <text x="535" y="204" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">from 90{'\u00b0'} to 12{'\u00b0'} from latch</text>

          <rect x="395" y="240" width="280" height="60" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="535" y="266" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#5B21B6">{d('60', '1525')} depth on pull side</text>
          <text x="535" y="284" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">wheelchair needs room to pull door toward them</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="img" aria-labelledby="door-hard-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="100" y="150" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Lever {'\u2714'}</text>
          ...
          <text x="210" y="150" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Push bar {'\u2714'}</text>
          ...
          <text x="100" y="248" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" fontWeight="600">Round knob {'\u2718'}</text>

          {/* Height range */}
          <rect x="180" y="185" width="120" height="40" rx="8" fill="#7C3AED" opacity="0.05" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="240" y="203" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="600">{d('34', '865')}{'\u2013'}{d('48', '1220')}</text>
          <text x="240" y="218" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">handle height</text>
          ...
          <text x="535" y="200" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A" fontWeight="600">threshold</text>

          {/* 1/2" dimension */}
          <line x1="575" y1="206" x2="575" y2="220" stroke="#2563EB" strokeWidth="1.2" />
          <rect x="580" y="205" width="70" height="20" rx="6" fill="#2563EB" />
          <text x="615" y="219" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('\u00bd', '13')} max</text>

          {/* Door surface note */}
          <rect x="390" y="80" width="280" height="50" rx="8" fill="#B45309" opacity="0.04" stroke="#B45309" strokeWidth="1.5" />
          <text x="530" y="100" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#78350F" fontWeight="600">Bottom {d('10', '255')} must be smooth</text>
          <text x="530" y="118" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F">on push side {'\u2014'} wheelchair footrests push here</text>
          ...
          <text x="450" y="240" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">wheelchair approaches</text>
