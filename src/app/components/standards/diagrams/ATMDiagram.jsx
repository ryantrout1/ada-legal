    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="atm-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Physical access</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Blind/low vision access</text>

          {/* LEFT: Physical */}
          {/* ATM machine */}
          <rect x="120" y="80" width="100" height="170" rx="6" fill="var(--dx-label)" opacity="0.08" stroke="var(--dx-label)" strokeWidth="1.5" />
          <rect x="135" y="95" width="70" height="40" rx="3" fill="var(--dx-orange)" opacity="0.06" stroke="var(--dx-orange)" strokeWidth="1" />
          <text x="170" y="118" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">screen</text>
          <rect x="140" y="150" width="60" height="30" rx="2" fill="var(--dx-line)" opacity="0.06" stroke="var(--dx-line)" strokeWidth="1" />
          <text x="170" y="169" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-line)">keypad</text>
          <rect x="155" y="195" width="30" height="10" rx="2" fill="var(--dx-line)" opacity="0.1" />
          <text x="170" y="220" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-line)">cash slot</text>

          {/* 48" max */}
          <line x1="240" y1="95" x2="240" y2="260" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="234" y1="95" x2="246" y2="95" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="234" y1="260" x2="246" y2="260" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <rect x="248" y="168" width="70" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="283" y="182" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{'\u2264'} 48{'\u2033'}</text>
          <text x="283" y="200" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">all controls</text>
          ...
          {/* Floor */}
          <line x1="20" y1="260" x2="330" y2="260" stroke="var(--dx-label)" strokeWidth="2" />
          <text x="170" y="282" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">30{'\u2033'}{'\u00d7'}48{'\u2033'} clear floor</text>

          {/* DIVIDER */}
          <line x1="370" y1="20" x2="370" y2="320" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Vision access */}
          <rect x="400" y="70" width="280" height="50" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Must speak all on-screen text</text>
          <text x="540" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">through headphone jack (3.5mm) for privacy</text>

          <rect x="400" y="135" width="280" height="50" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="540" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">Braille instructions required</text>
          <text x="540" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">operating instructions on the machine</text>

          <rect x="400" y="200" width="280" height="50" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="540" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">Raised dot on the {'\u201c'}5{'\u201d'} key</text>
          <text x="540" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">tactile keypad orientation (like a phone)</text>

          <rect x="400" y="265" width="280" height="40" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="540" y="289" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">All transactions available by speech</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} ATMs & Fare Machines</p>
        <KeyFact color="var(--dx-orange)" number={`\u2264 48\u2033`}>All controls within reach range</KeyFact>
        <KeyFact color="var(--dx-green)" number="Speech">Must read all screen content aloud via headphone jack</KeyFact>
        <KeyFact color="var(--dx-violet)" number="Braille">Operating instructions in Braille on the machine</KeyFact>
        <KeyFact color="var(--dx-blue)" number="Tactile">{`Raised dot on "5" key for orientation`}</KeyFact>
      </div>
      <style>{`
