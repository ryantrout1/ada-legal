    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="img" aria-labelledby="atm-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="118" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C">screen</text>
          <rect x="140" y="150" width="60" height="30" rx="2" fill="#475569" opacity="0.06" stroke="#475569" strokeWidth="1" />
          <text x="170" y="169" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#475569">keypad</text>
          <rect x="155" y="195" width="30" height="10" rx="2" fill="#475569" opacity="0.1" />
          <text x="170" y="220" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#475569">cash slot</text>
          ...
          <text x="283" y="182" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{'\u2264'} 48{'\u2033'}</text>
          <text x="283" y="200" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">all controls</text>
          ...
          <text x="170" y="282" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">30{'\u2033'}{'\u00d7'}48{'\u2033'} clear floor</text>
          ...
          <text x="540" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Must speak all on-screen text</text>
          <text x="540" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">through headphone jack (3.5mm) for privacy</text>

          <rect x="400" y="135" width="280" height="50" rx="10" fill="#C2410C" opacity="0.04" stroke="#C2410C" strokeWidth="1.5" />
          <text x="540" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Braille instructions required</text>
          <text x="540" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">operating instructions on the machine</text>

          <rect x="400" y="200" width="280" height="50" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="540" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Raised dot on the {'\u201c'}5{'\u201d'} key</text>
          <text x="540" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">tactile keypad orientation (like a phone)</text>

          <rect x="400" y="265" width="280" height="40" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="540" y="289" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">All transactions available by speech</text>
