    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="img" aria-labelledby="df-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="283" y="249" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('36', '915')} max</text>
          ...
          <text x="80" y="272" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">forward approach</text>

          {/* Knee clearance note */}
          <text x="190" y="210" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">knee space</text>
          <text x="190" y="224" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">underneath</text>
          ...
          <text x="638" y="234" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('38', '965')}{'\u2013'}{d('43', '1090')}</text>
          ...
          <text x="450" y="260" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">parallel approach</text>
          ...
          <text x="235" y="316" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F" fontWeight="600">water flow: {d('4', '100')} min high</text>
