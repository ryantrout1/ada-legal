  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Two Heights Required</h2>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="df-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Standing height</text>

          {/* LEFT: Wheelchair fountain */}
          {/* Wall */}
          <rect x="150" y="70" width="10" height="260" fill="var(--dx-line)" rx="2" />

          {/* Fountain unit */}
          <rect x="160" y="160" width="60" height="20" rx="3" fill="var(--dx-orange)" opacity="0.1" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <rect x="160" y="170" width="60" height="8" rx="1" fill="var(--dx-orange)" opacity="0.05" />

          {/* 36" max height */}
          <line x1="240" y1="160" x2="240" y2="330" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="234" y1="160" x2="246" y2="160" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="234" y1="330" x2="246" y2="330" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <rect x="248" y="235" width="70" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="283" y="249" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('36', '915')} max</text>
          ...
          <g transform="translate(60,200)" opacity="0.5">
            ...
            <line x1="20" y1="10" x2="20" y2="40" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="20" y1="22" x2="35" y2="32" stroke="var(--dx-line)" strokeWidth="1.5" strokeLinecap="round" />
            <circle cx="8" cy="52" r="8" fill="none" stroke="var(--dx-line)" strokeWidth="1.2" />
            <circle cx="32" cy="52" r="8" fill="none" stroke="var(--dx-line)" strokeWidth="1.2" />
          </g>
          <text x="80" y="272" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">forward approach</text>

          {/* Knee clearance note */}
          <text x="190" y="210" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">knee space</text>
          <text x="190" y="224" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">underneath</text>

          {/* Floor */}
          <line x1="30" y1="330" x2="330" y2="330" stroke="var(--dx-label)" strokeWidth="2" />
          ...
          <rect x="500" y="70" width="10" height="260" fill="var(--dx-line)" rx="2" />

          {/* Fountain unit (higher) */}
          <rect x="510" y="130" width="60" height="20" rx="3" fill="var(--dx-green)" opacity="0.1" stroke="var(--dx-green)" strokeWidth="1.5" />

          {/* 38-43" height */}
          <line x1="590" y1="130" x2="590" y2="330" stroke="var(--dx-green)" strokeWidth="1.2" />
          <line x1="584" y1="130" x2="596" y2="130" stroke="var(--dx-green)" strokeWidth="1.2" />
          <line x1="584" y1="330" x2="596" y2="330" stroke="var(--dx-green)" strokeWidth="1.2" />
          <rect x="598" y="220" width="80" height="20" rx="6" fill="var(--dx-green)" />
          <text x="638" y="234" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('38', '965')}{'\u2013'}{d('43', '1090')}</text>

          {/* Person standing */}
          <g transform="translate(420,100)" opacity="0.5">
            <circle cx="30" cy="0" r="10" fill="var(--dx-line)" stroke="var(--dx-line)" strokeWidth="1.5" />
            <line x1="30" y1="12" x2="30" y2="80" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="30" y1="80" x2="18" y2="140" stroke="var(--dx-line)" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="30" y1="80" x2="42" y2="140" stroke="var(--dx-line)" strokeWidth="1.5" strokeLinecap="round" />
            <line x1="30" y1="35" x2="50" y2="55" stroke="var(--dx-line)" strokeWidth="1.5" strokeLinecap="round" />
          </g>
          <text x="450" y="260" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">parallel approach</text>

          {/* Floor */}
          <line x1="390" y1="330" x2="700" y2="330" stroke="var(--dx-label)" strokeWidth="2" />

          {/* Water flow note */}
          <rect x="160" y="300" width="150" height="24" rx="6" fill="var(--dx-amber)" opacity="0.06" stroke="var(--dx-amber)" strokeWidth="1" />
          <text x="235" y="316" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)" fontWeight="600">water flow: {d('4', '100')} min high</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Drinking Fountains</p>
        <KeyFact color="var(--dx-orange)" number={`\u2264 ${d('36', '915')}`}>Wheelchair fountain spout height</KeyFact>
        <KeyFact color="var(--dx-green)" number={`${d('38', '965')}\u2013${d('43', '1090')}`}>Standing fountain spout height</KeyFact>
        <KeyFact color="var(--dx-amber)" number={d('4', '100')}>Minimum water flow height (for cup/bottle filling)</KeyFact>
        <KeyFact color="var(--dx-blue)" number="2 types">Every floor needs both wheelchair and standing heights</KeyFact>
      </div>
