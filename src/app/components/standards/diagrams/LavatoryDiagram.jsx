  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Accessible Sink</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 360" role="group" aria-labelledby="lav-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* Wall */}
          <rect x="160" y="60" width="10" height="240" fill="var(--dx-line)" rx="2" />
          {/* Counter/rim */}
          <rect x="170" y="130" width="100" height="8" rx="2" fill="var(--dx-label)" />
          <text x="220" y="122" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">sink rim</text>
          {/* Sink bowl */}
          <path d="M 185 138 Q 220 190 255 138" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1" />
          {/* Pipes */}
          <line x1="220" y1="185" x2="220" y2="260" stroke="var(--dx-label)" strokeWidth="2" />
          <rect x="210" y="195" width="20" height="60" rx="4" fill="var(--dx-amber)" opacity="0.08" stroke="var(--dx-amber)" strokeWidth="1.5" />
          <text x="250" y="228" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)" fontWeight="600">insulated</text>
          <text x="250" y="242" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)">pipes</text>
          {/* 34" max height */}
          <line x1="290" y1="130" x2="290" y2="300" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="284" y1="130" x2="296" y2="130" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="284" y1="300" x2="296" y2="300" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <rect x="298" y="206" width="60" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="328" y="220" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('34', '865')} max</text>
          <text x="328" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">rim height</text>
          {/* Faucet */}
          <rect x="200" y="118" width="16" height="12" rx="2" fill="var(--dx-green)" opacity="0.15" stroke="var(--dx-green)" strokeWidth="1" />
          <text x="232" y="115" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">lever faucet</text>
          {/* Knee space */}
          <rect x="170" y="170" width="90" height="80" rx="2" fill="var(--dx-violet)" opacity="0.03" stroke="var(--dx-violet)" strokeWidth="1" strokeDasharray="4 3" />
          <text x="215" y="210" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">knee space</text>
          ...
          <g transform="translate(60,160)" opacity="0.5">
            ...
            <line x1="20" y1="9" x2="20" y2="35" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="20" y1="20" x2="35" y2="30" stroke="var(--dx-line)" strokeWidth="1.5" strokeLinecap="round" />
            <circle cx="10" cy="46" r="7" fill="none" stroke="var(--dx-line)" strokeWidth="1.2" />
            <circle cx="30" cy="46" r="7" fill="none" stroke="var(--dx-line)" strokeWidth="1.2" />
          </g>
          {/* Floor */}
          <line x1="30" y1="300" x2="340" y2="300" stroke="var(--dx-label)" strokeWidth="2" />

          {/* DIVIDER */}
          <line x1="380" y1="40" x2="380" y2="340" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Checklist */}
          <rect x="410" y="65" width="280" height="50" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="550" y="86" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">Rim/counter: {d('34', '865')} max above floor</text>
          <text x="550" y="103" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">with knee and toe clearance underneath</text>
          <rect x="410" y="128" width="280" height="50" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="550" y="149" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Lever, push, or sensor faucet</text>
          <text x="550" y="166" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">no twist knobs {'\u2014'} one hand, {'\u2264'} 5 lbs</text>
          <rect x="410" y="191" width="280" height="50" rx="10" fill="var(--dx-amber)" opacity="0.04" stroke="var(--dx-amber)" strokeWidth="1.5" />
          <text x="550" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-amber)" fontWeight="600">Hot pipes must be insulated</text>
          <text x="550" y="229" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)">prevents burns {'\u2014'} legs are directly underneath</text>
          <rect x="410" y="254" width="280" height="40" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="550" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">30{'\u2033'}{'\u00d7'}48{'\u2033'} clear floor, forward approach</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Lavatories</p>
        <KeyFact color="var(--dx-orange)" number={`\u2264 ${d('34', '865')}`}>Maximum rim/counter height</KeyFact>
        <KeyFact color="var(--dx-green)" number="Lever">Faucet must work with one hand, no twisting</KeyFact>
        <KeyFact color="var(--dx-amber)" number="Insulate">Hot water pipes must be covered to prevent burns</KeyFact>
      </div>
      <style>{`
