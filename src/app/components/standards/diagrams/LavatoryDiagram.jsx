    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 360" role="group" aria-labelledby="lav-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="220" y="122" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">sink rim</text>
          {/* Sink bowl */}
          ...
          <text x="250" y="228" fontFamily="var(--font-body)" fontSize="10" fill="#B45309" fontWeight="600">insulated</text>
          <text x="250" y="242" fontFamily="var(--font-body)" fontSize="10" fill="#B45309">pipes</text>
          {/* 34" max height */}
          ...
          <text x="328" y="220" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('34', '865')} max</text>
          <text x="328" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">rim height</text>
          {/* Faucet */}
          <rect x="200" y="118" width="16" height="12" rx="2" fill="#15803D" opacity="0.15" stroke="#15803D" strokeWidth="1" />
          <text x="232" y="115" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">lever faucet</text>
          {/* Knee space */}
          <rect x="170" y="170" width="90" height="80" rx="2" fill="#7C3AED" opacity="0.03" stroke="#7C3AED" strokeWidth="1" strokeDasharray="4 3" />
          <text x="215" y="210" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">knee space</text>
          ...
          <text x="550" y="86" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Rim/counter: {d('34', '865')} max above floor</text>
          <text x="550" y="103" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">with knee and toe clearance underneath</text>
          <rect x="410" y="128" width="280" height="50" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="550" y="149" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Lever, push, or sensor faucet</text>
          <text x="550" y="166" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">no twist knobs {'\u2014'} one hand, {'\u2264'} 5 lbs</text>
          <rect x="410" y="191" width="280" height="50" rx="10" fill="#B45309" opacity="0.04" stroke="#B45309" strokeWidth="1.5" />
          <text x="550" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#78350F" fontWeight="600">Hot pipes must be insulated</text>
          <text x="550" y="229" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F">prevents burns {'\u2014'} legs are directly underneath</text>
          <rect x="410" y="254" width="280" height="40" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="550" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">30{'\u2033'}{'\u00d7'}48{'\u2033'} clear floor, forward approach</text>
