...
export default function AssistiveListeningDiagram() {
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ marginBottom: '8px' }}><h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Assistive Listening Systems</h2></div>
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 320" role="group" aria-labelledby="als-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Three system types</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Where required</text>

          {/* LEFT: System types */}
          <rect x="40" y="70" width="280" height="50" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="180" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">Hearing loop (induction)</text>
          <text x="180" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">works directly with hearing aid T-coil</text>

          <rect x="40" y="135" width="280" height="50" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="180" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">FM system (radio frequency)</text>
          <text x="180" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">requires handheld receiver</text>

          <rect x="40" y="200" width="280" height="50" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="180" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">Infrared (light-based)</text>
          <text x="180" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">good for privacy, requires receiver</text>

          <text x="180" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">25% of receivers must be hearing-aid compatible</text>

          {/* DIVIDER */}
          <line x1="370" y1="20" x2="370" y2="300" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Where required */}
          <rect x="400" y="70" width="280" height="40" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="95" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Theaters and cinemas</text>

          <rect x="400" y="122" width="280" height="40" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="147" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Courtrooms and hearing rooms</text>

          <rect x="400" y="174" width="280" height="40" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="199" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Meeting rooms and lecture halls</text>

          <rect x="400" y="226" width="280" height="40" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="251" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Houses of worship (with amplification)</text>

          <text x="540" y="290" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="600">Sign with hearing loss symbol must be posted</text>

          <Dots callouts={CALLOUTS} active={active} toggle={toggle} />
          <text x="20" y="312" fontFamily="var(--font-body)" fontSize="10" fill="var(--body-secondary)">Click or tap numbered callouts for details</text>
        </svg>
      </div>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Assistive Listening</p>
        <KeyFact color="var(--dx-orange)" number="25%">Minimum receivers that must be hearing-aid compatible</KeyFact>
        <KeyFact color="var(--dx-green)" number="3 types">Hearing loop, FM, or infrared {'\u2014'} facility chooses</KeyFact>
        <KeyFact color="var(--dx-violet)" number="Sign">International Symbol of Access for Hearing Loss must be posted</KeyFact>
      </div>
      <style>{`
