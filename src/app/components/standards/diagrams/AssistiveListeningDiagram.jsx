    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 320" role="group" aria-labelledby="als-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="180" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Hearing loop (induction)</text>
          <text x="180" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">works directly with hearing aid T-coil</text>

          <rect x="40" y="135" width="280" height="50" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="180" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">FM system (radio frequency)</text>
          <text x="180" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">requires handheld receiver</text>

          <rect x="40" y="200" width="280" height="50" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="180" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Infrared (light-based)</text>
          <text x="180" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">good for privacy, requires receiver</text>

          <text x="180" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">25% of receivers must be hearing-aid compatible</text>
          ...
          <text x="540" y="95" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Theaters and cinemas</text>

          <rect x="400" y="122" width="280" height="40" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="147" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Courtrooms and hearing rooms</text>

          <rect x="400" y="174" width="280" height="40" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="199" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Meeting rooms and lecture halls</text>

          <rect x="400" y="226" width="280" height="40" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="251" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Houses of worship (with amplification)</text>

          <text x="540" y="290" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C3AED" fontWeight="600">Sign with hearing loss symbol must be posted</text>
