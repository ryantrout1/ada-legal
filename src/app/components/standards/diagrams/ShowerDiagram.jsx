...
const CALLOUTS = [
  { id: 1, label: 'Transfer vs Roll-In', section: '\u00a7608.2', color: 'var(--dx-orange)', textColor: 'var(--dx-orange)', x: 100, y: 52, plain: 'Transfer showers are 36\u00d736 inches \u2014 the user transfers from a wheelchair onto a built-in seat. Roll-in showers are 60\u00d730 inches (standard) or 36\u00d760 inches (alternate) \u2014 a wheelchair can roll directly in. Roll-in showers have no curb (\u00bd inch max threshold). Transfer showers have a folding or fixed seat. Both types need 30\u00d748 inch clear floor space outside the shower.', legal: 'Transfer: \u201C36\u00d736 inches clear inside dimensions.\u201D Standard roll-in: \u201C30\u00d760 inches minimum.\u201D Alternate roll-in: \u201C36\u00d760 inches.\u201D Threshold: \u201C\u00bd inch maximum.\u201D', citation: '\u00a7608.2.1, \u00a7608.2.2, \u00a7608.7' },
  { id: 2, label: 'Grab Bars, Seat & Controls', section: '\u00a7608.3', color: 'var(--dx-green)', textColor: 'var(--dx-green)', x: 470, y: 52, plain: 'Transfer showers need grab bars across the back wall and side wall opposite the seat. Roll-in showers need bars on three walls. Seats: transfer type needs a folding seat 17\u201319 inches high. Controls must be between 38 and 48 inches above the shower floor, operable with one hand. A hand-held shower spray with 59-inch hose is required for all types. No shower enclosures that obstruct controls or transfer.', legal: 'Grab bars per \u00a7608.3. Seats per \u00a7608.4. Controls: \u201C38 inches minimum and 48 inches maximum above the shower floor.\u201D Spray: \u201CA shower spray unit with a hose 59 inches long minimum.\u201D', citation: '\u00a7608.3, \u00a7608.4, \u00a7608.5, \u00a7608.6' }
];
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Accessible Showers</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="sh-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          <title id="sh-title">Shower Types {'\u2014'} Transfer and Roll-In</title>
          <rect width="720" height="380" fill="var(--page-bg-subtle)" />
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Transfer shower (sit and transfer)</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Roll-in shower (wheelchair enters)</text>

          {/* LEFT: Transfer shower */}
          <rect x="60" y="80" width="130" height="130" rx="4" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="2" />
          <text x="125" y="140" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">36{'\u2033'}{'\u00d7'}36{'\u2033'}</text>
          {/* Seat */}
          <rect x="60" y="80" width="130" height="30" rx="2" fill="var(--dx-violet)" opacity="0.06" stroke="var(--dx-violet)" strokeWidth="1" />
          <text x="125" y="100" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="600">seat (folding)</text>
          {/* Grab bars */}
          <line x1="57" y1="85" x2="57" y2="205" stroke="var(--dx-green)" strokeWidth="3" strokeLinecap="round" />
          <line x1="65" y1="207" x2="185" y2="207" stroke="var(--dx-green)" strokeWidth="3" strokeLinecap="round" />
          <text x="30" y="150" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600" transform="rotate(-90 30 150)">grab bars</text>
          {/* Clear floor space */}
          <rect x="60" y="220" width="130" height="80" rx="2" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1" strokeDasharray="4 3" />
          <text x="125" y="260" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">clear floor</text>
          <text x="125" y="274" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">30{'\u2033'}{'\u00d7'}48{'\u2033'}</text>
          {/* Controls */}
          <rect x="178" y="145" width="12" height="12" rx="2" fill="var(--dx-amber)" opacity="0.2" stroke="var(--dx-amber)" strokeWidth="1" />
          <text x="204" y="150" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)" fontWeight="500">controls</text>
          <text x="204" y="164" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)">{d('38', '965')}{'\u2013'}{d('48', '1220')}</text>
          {/* Threshold */}
          <text x="125" y="320" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">{'\u00bd'}{'\u2033'} max threshold</text>

          {/* DIVIDER */}
          <line x1="360" y1="20" x2="360" y2="360" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Roll-in shower */}
          <rect x="400" y="80" width="260" height="110" rx="4" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="2" />
          <text x="530" y="130" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">60{'\u2033'}{'\u00d7'}30{'\u2033'}</text>
          <text x="530" y="148" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">no curb {'\u2014'} wheelchair rolls in</text>
          {/* Grab bars on 3 walls */}
          <line x1="397" y1="85" x2="397" y2="185" stroke="var(--dx-green)" strokeWidth="3" strokeLinecap="round" />
          <line x1="403" y1="187" x2="657" y2="187" stroke="var(--dx-green)" strokeWidth="3" strokeLinecap="round" />
          <line x1="663" y1="85" x2="663" y2="185" stroke="var(--dx-green)" strokeWidth="3" strokeLinecap="round" />
          <text x="530" y="178" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">grab bars on 3 walls</text>
          {/* Entry (open side) */}
          <text x="530" y="98" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">{'\u2191'} open entry (long side)</text>
          {/* Clear floor */}
          <rect x="400" y="200" width="260" height="60" rx="2" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1" strokeDasharray="4 3" />
          <text x="530" y="230" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">clear floor: 30{'\u2033'}{'\u00d7'}60{'\u2033'}</text>
          <text x="530" y="248" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">wheelchair rolls straight in</text>
          {/* Shower spray note */}
          <rect x="400" y="275" width="260" height="40" rx="8" fill="var(--dx-amber)" opacity="0.05" stroke="var(--dx-amber)" strokeWidth="1.5" />
          <text x="530" y="293" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-amber)" fontWeight="600">Hand-held spray: 59{'\u2033'} hose min</text>
          <text x="530" y="308" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)">required for all shower types</text>
          {/* Seat */}
          <text x="530" y="338" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="500">seat: 17{'\u2033'}{'\u2013'}19{'\u2033'} high, holds 250 lbs</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Showers</p>
        <KeyFact color="var(--dx-orange)" number={`36\u2033\u00d736\u2033`}>Transfer shower size (with seat)</KeyFact>
        <KeyFact color="var(--dx-green)" number={`60\u2033\u00d730\u2033`}>Standard roll-in shower (no curb)</KeyFact>
        <KeyFact color="var(--dx-amber)" number={`${d('38', '965')}\u2013${d('48', '1220')}`}>Control height above shower floor</KeyFact>
        <KeyFact color="var(--dx-violet)" number={d('59', '1500')}>Minimum shower hose length</KeyFact>
      </div>
      <style>{`
