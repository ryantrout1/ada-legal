    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="sh-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="125" y="140" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#C2410C" fontWeight="600">36{'\u2033'}{'\u00d7'}36{'\u2033'}</text>
          {/* Seat */}
          <rect x="60" y="80" width="130" height="30" rx="2" fill="#7C3AED" opacity="0.06" stroke="#7C3AED" strokeWidth="1" />
          <text x="125" y="100" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="600">seat (folding)</text>
          {/* Grab bars */}
          ...
          <text x="30" y="150" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600" transform="rotate(-90 30 150)">grab bars</text>
          {/* Clear floor space */}
          <rect x="60" y="220" width="130" height="80" rx="2" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1" strokeDasharray="4 3" />
          <text x="125" y="260" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">clear floor</text>
          <text x="125" y="274" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">30{'\u2033'}{'\u00d7'}48{'\u2033'}</text>
          {/* Controls */}
          <rect x="178" y="145" width="12" height="12" rx="2" fill="#B45309" opacity="0.2" stroke="#B45309" strokeWidth="1" />
          <text x="204" y="150" fontFamily="var(--font-body)" fontSize="10" fill="#B45309" fontWeight="500">controls</text>
          <text x="204" y="164" fontFamily="var(--font-body)" fontSize="10" fill="#B45309">{d('38', '965')}{'\u2013'}{d('48', '1220')}</text>
          {/* Threshold */}
          <text x="125" y="320" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">{'\u00bd'}{'\u2033'} max threshold</text>
          ...
          <text x="530" y="130" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#15803D" fontWeight="600">60{'\u2033'}{'\u00d7'}30{'\u2033'}</text>
          <text x="530" y="148" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D">no curb {'\u2014'} wheelchair rolls in</text>
          ...
          <text x="530" y="178" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D">grab bars on 3 walls</text>
          {/* Entry (open side) */}
          <text x="530" y="98" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">{'\u2191'} open entry (long side)</text>
          {/* Clear floor */}
          <rect x="400" y="200" width="260" height="60" rx="2" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1" strokeDasharray="4 3" />
          <text x="530" y="230" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">clear floor: 30{'\u2033'}{'\u00d7'}60{'\u2033'}</text>
          <text x="530" y="248" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">wheelchair rolls straight in</text>
          {/* Shower spray note */}
          <rect x="400" y="275" width="260" height="40" rx="8" fill="#B45309" opacity="0.05" stroke="#B45309" strokeWidth="1.5" />
          <text x="530" y="293" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#78350F" fontWeight="600">Hand-held spray: 59{'\u2033'} hose min</text>
          <text x="530" y="308" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F">required for all shower types</text>
          {/* Seat */}
          <text x="530" y="338" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="500">seat: 17{'\u2033'}{'\u2013'}19{'\u2033'} high, holds 250 lbs</text>
