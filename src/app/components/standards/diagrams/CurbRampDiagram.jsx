  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>The Ramp Itself</h3>
        {unitToggle}
      </div>
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 360" role="img" aria-labelledby="curb-ramp-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="90" y="132" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">sidewalk</text>
          ...
          <text x="360" y="284" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">street</text>
          ...
          <text x="220" y="210" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">1:12 max slope</text>

          {/* Counter slope at bottom */}
          <rect x="260" y="290" width="90" height="18" rx="5" fill="#B45309" />
          <text x="305" y="303" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">1:20 counter max</text>
          ...
          <text x="550" y="185" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="600">ramp</text>
          ...
          <text x="549" y="295" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('36', '915')} min</text>

          {/* Left flare */}
          <path d="M 510 100 L 470 100 L 510 260 Z" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="476" y="190" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">flare</text>

          {/* Right flare */}
          <path d="M 590 100 L 630 100 L 590 260 Z" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="616" y="190" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">flare</text>

          {/* Flare slope label */}
          <rect x="628" y="165" width="70" height="18" rx="5" fill="#15803D" />
          <text x="663" y="178" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">1:10 max</text>

          {/* Sidewalk at top */}
          <text x="550" y="88" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">sidewalk</text>
          {/* Street at bottom */}
          <text x="550" y="320" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">street</text>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '40px', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Warning Bumps & Crosswalk Alignment</h3>
      </div>
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 320" role="img" aria-labelledby="curb-warn-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="218" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="600">truncated domes</text>
          <text x="170" y="234" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">(raised bumps you can feel)</text>
          ...
          <text x="310" y="183" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('24', '610')} min</text>

          <text x="170" y="260" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">warns: you{'\u2019'}re entering the road</text>

          {/* Street label */}
          <text x="170" y="290" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">{'\u2193'} street below</text>
          ...
          <text x="510" y="155" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">sidewalk</text>
          <text x="510" y="170" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">corner</text>

          {/* Ramp 1 pointing down */}
          <rect x="480" y="240" width="60" height="40" rx="2" fill="#2563EB" opacity="0.1" stroke="#2563EB" strokeWidth="2" />
          <text x="510" y="263" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A" fontWeight="600">ramp 1</text>
          <text x="510" y="296" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">{'\u2193'} crosswalk A</text>

          {/* Ramp 2 pointing right */}
          <rect x="570" y="120" width="40" height="60" rx="2" fill="#2563EB" opacity="0.1" stroke="#2563EB" strokeWidth="2" />
          <text x="590" y="155" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A" fontWeight="600">ramp 2</text>
          <text x="640" y="155" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">crosswalk B {'\u2192'}</text>

          {/* X on diagonal */}
          <rect x="430" y="75" width="90" height="34" rx="6" fill="#C2410C" opacity="0.06" stroke="#C2410C" strokeWidth="1.5" />
          <text x="475" y="90" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="600">{'\u2718'} single diagonal</text>
          <text x="475" y="103" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C">ramp is not OK</text>
