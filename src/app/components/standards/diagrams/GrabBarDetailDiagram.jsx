  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Grab Bar Details</h2>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="gb-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          <title id="gb-title">Grab Bar Cross-Section and Mounting Details</title>
          <rect width="720" height="340" fill="var(--page-bg-subtle)" />
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Cross-section</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Safety requirements</text>
          ...
          <rect x="74" y="160" width="34" height="16" rx="4" fill="var(--dx-green)" />
          <text x="91" y="172" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('1\u00bd', '38')}</text>
          <text x="91" y="190" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="500">clearance</text>
          {/* Bar circle */}
          <circle cx="145" cy="155" r="25" fill="var(--dx-orange)" opacity="0.08" stroke="var(--dx-orange)" strokeWidth="2.5" />
          <line x1="120" y1="155" x2="170" y2="155" stroke="var(--dx-orange)" strokeWidth="1" />
          <rect x="110" y="198" width="70" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="145" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('1\u00bc', '32')}{'\u2013'}{d('2', '51')}</text>
          <text x="145" y="232" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">diameter</text>
          {/* Height from floor */}
          <rect x="210" y="100" width="100" height="22" rx="6" fill="var(--dx-violet)" opacity="0.08" stroke="var(--dx-violet)" strokeWidth="1" />
          <text x="260" y="115" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="600">{d('33', '840')}{'\u2013'}{d('36', '915')} high</text>
          <text x="260" y="135" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">above floor</text>

          {/* DIVIDER */}
          <line x1="360" y1="40" x2="360" y2="320" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Safety */}
          <rect x="400" y="65" width="280" height="50" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="540" y="86" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">Must hold 250 lbs in any direction</text>
          <text x="540" y="103" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">structural anchoring is critical</text>
          <rect x="400" y="128" width="280" height="50" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="149" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">{'\u2718'} Must NOT rotate in fittings</text>
          <text x="540" y="166" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">a spinning bar is worse than no bar</text>
          <rect x="400" y="191" width="280" height="50" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="540" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">Smooth surface, no sharp edges</text>
          <text x="540" y="229" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">no bolt heads or rough brackets in grip zone</text>
          <rect x="400" y="254" width="280" height="40" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="540" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">Continuous grip {'\u2014'} no breaks along length</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Grab Bars</p>
        <KeyFact color="var(--dx-orange)" number={`${d('1\u00bc', '32')}\u2013${d('2', '51')}`}>Round bar diameter</KeyFact>
        <KeyFact color="var(--dx-green)" number={d('1\u00bd', '38')}>Wall clearance (exactly)</KeyFact>
        <KeyFact color="var(--dx-violet)" number={`${d('33', '840')}\u2013${d('36', '915')}`}>Mounting height above floor</KeyFact>
        <KeyFact color="var(--dx-orange)" number="250 lbs">Must resist this force at any point, any direction</KeyFact>
      </div>
      <style>{`
