    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="img" aria-labelledby="gb-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="91" y="172" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('1\u00bd', '38')}</text>
          <text x="91" y="190" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="500">clearance</text>
          {/* Bar circle */}
          ...
          <text x="145" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('1\u00bc', '32')}{'\u2013'}{d('2', '51')}</text>
          <text x="145" y="232" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">diameter</text>
          {/* Height from floor */}
          <rect x="210" y="100" width="100" height="22" rx="6" fill="#7C3AED" opacity="0.08" stroke="#7C3AED" strokeWidth="1" />
          <text x="260" y="115" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="600">{d('33', '840')}{'\u2013'}{d('36', '915')} high</text>
          <text x="260" y="135" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">above floor</text>
          ...
          <text x="540" y="86" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Must hold 250 lbs in any direction</text>
          <text x="540" y="103" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">structural anchoring is critical</text>
          <rect x="400" y="128" width="280" height="50" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="149" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">{'\u2718'} Must NOT rotate in fittings</text>
          <text x="540" y="166" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">a spinning bar is worse than no bar</text>
          <rect x="400" y="191" width="280" height="50" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="540" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Smooth surface, no sharp edges</text>
          <text x="540" y="229" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">no bolt heads or rough brackets in grip zone</text>
          <rect x="400" y="254" width="280" height="40" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="540" y="278" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Continuous grip {'\u2014'} no breaks along length</text>
