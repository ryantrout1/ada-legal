...
const HEAD_CALLOUTS = [
  {
    ...
    color: 'var(--dx-violet)', textColor: 'var(--dx-violet)', x: 260, y: 52,
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Wall-Mounted Objects</h2>
        {unitToggle}
      </div>

      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 400" role="group" aria-labelledby="wall-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* Wall */}
          <rect x="50" y="50" width="12" height="310" fill="var(--dx-line)" rx="2" />
          <text x="45" y="48" textAnchor="end" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">wall</text>

          {/* Fire extinguisher cabinet (VIOLATION example) */}
          <rect x="62" y="130" width="50" height="60" rx="4" fill="var(--dx-orange)" opacity="0.08" stroke="var(--dx-orange)" strokeWidth="2" />
          <text x="87" y="155" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="600">fire</text>
          <text x="87" y="167" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="600">ext.</text>

          {/* 4" max protrusion dimension */}
          <line x1="62" y1="200" x2="112" y2="200" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <line x1="62" y1="194" x2="62" y2="206" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <line x1="112" y1="194" x2="112" y2="206" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <rect x="68" y="206" width="64" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="100" y="220" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('4', '100')} max</text>

          {/* 27" line (critical!) */}
          <line x1="30" y1="275" x2="330" y2="275" stroke="var(--dx-amber)" strokeWidth="2.5" strokeDasharray="8 4" />
          <rect x="135" y="264" width="100" height="22" rx="6" fill="var(--dx-amber)" />
          <text x="185" y="279" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="var(--page-bg)">{d('27', '685')} cane line</text>

          {/* 80" line (top) */}
          <line x1="30" y1="60" x2="330" y2="60" stroke="var(--dx-label)" strokeWidth="1" strokeDasharray="4 4" />
          <rect x="240" y="50" width="56" height="20" rx="6" fill="var(--dx-label)" />
          <text x="268" y="64" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('80', '2030')}</text>

          {/* Danger zone highlight (27-80") */}
          <rect x="62" y="60" width="60" height="215" fill="var(--dx-orange)" opacity="0.03" stroke="var(--dx-orange)" strokeWidth="1" strokeDasharray="4 3" rx="4" />
          <text x="92" y="100" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="600" opacity="0.5">danger</text>
          <text x="92" y="112" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="600" opacity="0.5">zone</text>

          {/* Person with cane */}
          <g transform="translate(195,140)">
            <circle cx="30" cy="0" r="12" fill="var(--dx-line)" stroke="var(--dx-line)" strokeWidth="1.8" />
            <line x1="30" y1="14" x2="30" y2="85" stroke="var(--dx-line)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="30" y1="85" x2="18" y2="150" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="30" y1="85" x2="42" y2="150" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="30" y1="40" x2="12" y2="65" stroke="var(--dx-line)" strokeWidth="1.8" strokeLinecap="round" />
            <line x1="30" y1="40" x2="48" y2="65" stroke="var(--dx-line)" strokeWidth="1.8" strokeLinecap="round" />
            {/* Cane */}
            <line x1="14" y1="65" x2="-35" y2="150" stroke="var(--dx-amber)" strokeWidth="2.5" strokeLinecap="round" />
            <text x="-20" y="168" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)" fontWeight="600">cane</text>
          </g>

          {/* Floor */}
          <line x1="20" y1="360" x2="340" y2="360" stroke="var(--dx-label)" strokeWidth="2" />


          {/* DIVIDER */}
          <line x1="360" y1="20" x2="360" y2="380" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />
          ...
          {/* Wall */}
          <rect x="420" y="50" width="12" height="310" fill="var(--dx-line)" rx="2" />

          {/* Drinking fountain (OK, below 27") */}
          <rect x="432" y="265" width="55" height="35" rx="4" fill="var(--dx-green)" opacity="0.08" stroke="var(--dx-green)" strokeWidth="2" />
          <text x="460" y="314" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">fountain (OK)</text>

          {/* 27" line */}
          <line x1="400" y1="275" x2="700" y2="275" stroke="var(--dx-amber)" strokeWidth="2.5" strokeDasharray="8 4" />

          {/* Safe zone highlight (below 27") */}
          <rect x="432" y="275" width="65" height="85" fill="var(--dx-green)" opacity="0.03" stroke="var(--dx-green)" strokeWidth="1" strokeDasharray="4 3" rx="4" />
          <text x="464" y="340" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600" opacity="0.5">safe zone</text>
          ...
          <g transform="translate(555,140)">
            ...
            <line x1="14" y1="65" x2="-60" y2="148" stroke="var(--dx-green)" strokeWidth="2.5" strokeLinecap="round" />
            <circle cx="-60" cy="150" r="4" fill="var(--dx-green)" opacity="0.4" />
            <text x="-48" y="168" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">detected!</text>
          </g>

          {/* Floor */}
          <line x1="390" y1="360" x2="710" y2="360" stroke="var(--dx-label)" strokeWidth="2" />
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        ...
        <KeyFact color="var(--dx-amber)" number={d('27', '685')}>The cane detection line {'\u2014'} objects above this are invisible to a cane</KeyFact>
        <KeyFact color="var(--dx-orange)" number={`\u2264 ${d('4', '100')}`}>Maximum protrusion for objects between 27{'\u2033'} and 80{'\u2033'} above the floor</KeyFact>
        <KeyFact color="var(--dx-green)" number="No limit">Objects at or below 27{'\u2033'} can protrude any amount (cane detects them)</KeyFact>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '40px', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Overhead Clearance</h2>
      </div>

      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="head-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* Ceiling */}
          <rect x="40" y="68" width="260" height="8" rx="2" fill="var(--dx-label)" />
          <text x="170" y="60" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">ceiling</text>

          {/* 80" dimension */}
          <line x1="30" y1="76" x2="30" y2="340" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <line x1="22" y1="76" x2="38" y2="76" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <line x1="22" y1="340" x2="38" y2="340" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <rect x="6" y="200" width="50" height="22" rx="6" fill="var(--dx-violet)" />
          <text x="31" y="215" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="var(--page-bg)">{d('80', '2030')}</text>
          <text x="31" y="236" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="600">min clear</text>

          {/* Person walking */}
          <g transform="translate(160,100)">
            <circle cx="20" cy="0" r="12" fill="var(--dx-line)" stroke="var(--dx-line)" strokeWidth="1.8" />
            <line x1="20" y1="14" x2="20" y2="85" stroke="var(--dx-line)" strokeWidth="2.5" strokeLinecap="round" />
            <line x1="20" y1="85" x2="8" y2="150" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="20" y1="85" x2="32" y2="150" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" />
            <line x1="20" y1="40" x2="4" y2="65" stroke="var(--dx-line)" strokeWidth="1.8" strokeLinecap="round" />
            <line x1="20" y1="40" x2="36" y2="65" stroke="var(--dx-line)" strokeWidth="1.8" strokeLinecap="round" />
          </g>

          {/* Floor */}
          <line x1="20" y1="340" x2="330" y2="340" stroke="var(--dx-label)" strokeWidth="2" />
          ...
          <line x1="380" y1="270" x2="700" y2="70" stroke="var(--dx-label)" strokeWidth="3" />
          <text x="620" y="100" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">stairway above</text>

          {/* 80" point on diagonal */}
          <line x1="480" y1="200" x2="480" y2="340" stroke="var(--dx-violet)" strokeWidth="1.2" strokeDasharray="4 3" />
          <rect x="455" y="192" width="50" height="18" rx="5" fill="var(--dx-violet)" opacity="0.8" />
          <text x="480" y="205" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('80', '2030')}</text>

          {/* Barrier/guardrail at cane detection line */}
          <rect x="476" y="285" width="10" height="55" rx="2" fill="var(--dx-blue)" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="500" y="300" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)" fontWeight="600">barrier</text>
          <text x="500" y="314" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">(at {d('27', '685')}</text>
          <text x="500" y="326" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">or lower)</text>

          {/* Danger zone (low headroom area) */}
          <path d="M 380 270 L 380 340 L 480 340 L 480 200 Z" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1" strokeDasharray="4 3" />
          <text x="430" y="310" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="600" opacity="0.6">low</text>
          <text x="430" y="322" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="600" opacity="0.6">headroom</text>
          ...
          <g transform="translate(555,100)">
            ...
            <line x1="4" y1="65" x2="-70" y2="185" stroke="var(--dx-blue)" strokeWidth="2.5" strokeLinecap="round" />
            <circle cx="-70" cy="187" r="4" fill="var(--dx-blue)" opacity="0.4" />
          </g>

          {/* Floor */}
          <line x1="370" y1="340" x2="710" y2="340" stroke="var(--dx-label)" strokeWidth="2" />
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        ...
        <KeyFact color="var(--dx-violet)" number={d('80', '2030')}>Minimum overhead clearance in all walking areas (6 feet 8 inches)</KeyFact>
        <KeyFact color="var(--dx-blue)" number="Barrier">{`Where headroom drops below 80\u2033, a cane-detectable barrier at 27\u2033 or lower must warn people`}</KeyFact>
      </div>
      ...
      <style>{`
        ...
        g[role="button"]:focus .prot-fr{stroke:var(--accent);stroke-width:2.5} @media (prefers-reduced-motion: reduce) { .ada-diagram-wrap * { animation: none !important; transition: none !important; } }
      `}</style>
    </div>
  );
}
