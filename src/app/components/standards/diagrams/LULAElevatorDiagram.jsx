    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 370" role="group" aria-labelledby="lula-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="159" y="283" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('32', '815')} door</text>
          ...
          <text x="160" y="311" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('36', '915')} wide</text>
          ...
          <text x="293" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('54', '1370')}</text>
          <text x="293" y="190" fontFamily="var(--font-body)" fontSize="10" fill="#475569" fontWeight="600">deep</text>
          ...
          <text x="540" y="93" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Buildings with 2 stories or fewer</text>
          <text x="540" y="112" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">where a full elevator isn{'\u2019'}t required</text>

          <rect x="400" y="142" width="280" height="55" rx="10" fill="#B45309" opacity="0.04" stroke="#B45309" strokeWidth="1.5" />
          <text x="540" y="165" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#78350F" fontWeight="600">Max travel: 25 feet</text>
          <text x="540" y="184" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F">at 30 ft/min max speed (1{'\u2013'}2 stories)</text>

          <rect x="400" y="214" width="280" height="55" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="540" y="237" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Same control rules as standard</text>
          <text x="540" y="256" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">reach range, Braille, raised characters</text>
