  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>LULA Elevator</h2>
        {unitToggle}
      </div>
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 370" role="group" aria-labelledby="lula-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          <title id="lula-title">LULA Elevator Size and Usage Limitations</title>
          <rect width="720" height="370" fill="var(--page-bg-subtle)" />
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Smaller cab, tighter fit</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Where and when allowed</text>

          {/* LEFT: Cab plan view */}
          <rect x="80" y="80" width="160" height="180" rx="4" fill="var(--dx-orange)" opacity="0.03" stroke="var(--dx-line)" strokeWidth="2" />
          {/* Door at bottom */}
          <rect x="120" y="254" width="80" height="8" rx="1" fill="var(--page-bg-subtle)" />
          <line x1="120" y1="260" x2="120" y2="268" stroke="var(--dx-orange)" strokeWidth="2" />
          <line x1="200" y1="260" x2="200" y2="268" stroke="var(--dx-orange)" strokeWidth="2" />

          {/* Door width */}
          <rect x="123" y="270" width="72" height="18" rx="5" fill="var(--dx-orange)" />
          <text x="159" y="283" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('32', '815')} door</text>

          {/* Width */}
          <line x1="80" y1="295" x2="240" y2="295" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="80" y1="290" x2="80" y2="300" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="240" y1="290" x2="240" y2="300" stroke="var(--dx-line)" strokeWidth="1.2" />
          <rect x="122" y="298" width="76" height="18" rx="5" fill="var(--dx-line)" />
          <text x="160" y="311" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('36', '915')} wide</text>

          {/* Depth */}
          <line x1="258" y1="80" x2="258" y2="260" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="253" y1="80" x2="263" y2="80" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="253" y1="260" x2="263" y2="260" stroke="var(--dx-line)" strokeWidth="1.2" />
          <rect x="265" y="160" width="56" height="18" rx="5" fill="var(--dx-line)" />
          <text x="293" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('54', '1370')}</text>
          <text x="293" y="190" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-line)" fontWeight="600">deep</text>
          ...
          <text x="540" y="93" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Buildings with 2 stories or fewer</text>
          <text x="540" y="112" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">where a full elevator isn{'\u2019'}t required</text>

          <rect x="400" y="142" width="280" height="55" rx="10" fill="var(--dx-amber)" opacity="0.04" stroke="var(--dx-amber)" strokeWidth="1.5" />
          <text x="540" y="165" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-amber)" fontWeight="600">Max travel: 25 feet</text>
          <text x="540" y="184" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)">at 30 ft/min max speed (1{'\u2013'}2 stories)</text>

          <rect x="400" y="214" width="280" height="55" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="540" y="237" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">Same control rules as standard</text>
          <text x="540" y="256" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">reach range, Braille, raised characters</text>

          <Dots callouts={CALLOUTS} active={active} toggle={toggle} />
          <text x="20" y="358" fontFamily="var(--font-body)" fontSize="10" fill="var(--body-secondary)">Click or tap numbered callouts for details</text>
        </svg>
      </div>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} LULA Elevator</p>
        <KeyFact color="var(--dx-orange)" number={`${d('54', '1370')}\u00d7${d('36', '915')}`}>Minimum cab size (end-opening door)</KeyFact>
        <KeyFact color="var(--dx-orange)" number={d('32', '815')}>Minimum door width</KeyFact>
        <KeyFact color="var(--dx-green)" number="25 ft">Maximum travel distance</KeyFact>
      </div>
      ...
      <style>{`
        ...
        g[role="button"]:focus .lula-fr { stroke: var(--accent); stroke-width: 2.5; } @media (prefers-reduced-motion: reduce) { .ada-diagram-wrap * { animation: none !important; transition: none !important; } }
      `}</style>
    </div>
  );
}
