...
const CALLOUTS = [
  ...
  },
  {
    ...
    color: 'var(--dx-green)', textColor: 'var(--dx-green)', x: 420, y: 52,
  ...
  },
  {
    ...
    color: 'var(--dx-orange)', textColor: 'var(--dx-orange)', x: 580, y: 52,
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>{'\u00a7'}306 Knee & Toe Clearance</h2>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 450" role="group" aria-labelledby="knee-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          <title id="knee-title">Knee and Toe Clearance \u2014 Side Cross-Section</title>
          <rect width="720" height="450" fill="var(--page-bg-subtle)" />

          <text x="300" y="28" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">What fits under a counter or desk</text>

          {/* Wall */}
          <rect x="100" y="68" width="12" height="312" fill="var(--dx-line)" rx="2" />
          <text x="96" y="62" textAnchor="end" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">wall</text>

          {/* Counter/desk surface */}
          <rect x="112" y="138" width="230" height="12" rx="3" fill="var(--dx-label)" stroke="var(--dx-label)" strokeWidth="1.5" />
          <text x="227" y="132" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">counter / desk surface</text>

          {/* Floor */}
          <line x1="60" y1="380" x2="700" y2="380" stroke="var(--dx-label)" strokeWidth="2.5" />

          {/* Front edge line */}
          <line x1="342" y1="120" x2="342" y2="395" stroke="var(--dx-label)" strokeWidth="1" strokeDasharray="3 3" opacity="0.5" />
          <text x="346" y="118" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">front edge</text>

          {/* KNEE ZONE */}
          <path d="M 342 150 L 268 150 L 232 305 L 342 305 Z" fill="var(--dx-violet)" opacity="0.06" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="310" y="230" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600" opacity="0.6">knee</text>
          <text x="310" y="245" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600" opacity="0.6">zone</text>

          {/* TOE ZONE */}
          <rect x="112" y="305" width="230" height="75" fill="var(--dx-green)" opacity="0.06" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="227" y="348" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600" opacity="0.6">toe zone</text>

          {/* Taper line */}
          <line x1="268" y1="150" x2="232" y2="305" stroke="var(--dx-amber)" strokeWidth="2" strokeDasharray="5 3" />

          {/* === DIMENSIONS === */}

          {/* 27" height */}
          <line x1="78" y1="150" x2="78" y2="380" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <line x1="70" y1="150" x2="86" y2="150" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <line x1="70" y1="380" x2="86" y2="380" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <rect x="42" y="256" width="68" height="22" rx="6" fill="var(--dx-violet)" />
          <text x="76" y="271" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="var(--page-bg)">{d('27', '685')}</text>
          <text x="76" y="295" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="600">min high</text>

          {/* 9" toe height */}
          <rect x="42" y="332" width="52" height="20" rx="6" fill="var(--dx-green)" />
          <text x="68" y="346" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('9', '230')}</text>

          {/* 8" deep at 27" */}
          <line x1="268" y1="156" x2="342" y2="156" stroke="var(--dx-amber)" strokeWidth="1.2" />
          <line x1="268" y1="150" x2="268" y2="162" stroke="var(--dx-amber)" strokeWidth="1.2" />
          <rect x="272" y="160" width="66" height="20" rx="6" fill="var(--dx-amber)" />
          <text x="305" y="174" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('8', '205')} min</text>

          {/* 11" deep at 9" */}
          <line x1="232" y1="298" x2="342" y2="298" stroke="var(--dx-amber)" strokeWidth="1.2" />
          <line x1="232" y1="292" x2="232" y2="304" stroke="var(--dx-amber)" strokeWidth="1.2" />
          <rect x="250" y="278" width="66" height="20" rx="6" fill="var(--dx-amber)" />
          <text x="283" y="292" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('11', '280')} min</text>

          {/* 25" max total depth */}
          <line x1="112" y1="396" x2="342" y2="396" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <line x1="112" y1="389" x2="112" y2="403" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <line x1="342" y1="389" x2="342" y2="403" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <rect x="189" y="400" width="68" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="223" y="414" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('25', '635')} max</text>

          {/* 17" min toe depth */}
          <line x1="185" y1="372" x2="342" y2="372" stroke="var(--dx-blue)" strokeWidth="1.2" />
          <line x1="185" y1="365" x2="185" y2="379" stroke="var(--dx-blue)" strokeWidth="1.2" />
          <rect x="222" y="356" width="66" height="20" rx="6" fill="var(--dx-blue)" />
          <text x="255" y="370" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('17', '430')} min</text>
          ...
          <g transform="translate(420,175) scale(1.4)">
            ...
            <line x1="24" y1="30" x2="-15" y2="-5" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" opacity="0.4" />
            {/* Thighs going under counter */}
            <line x1="25" y1="50" x2="-10" y2="20" stroke="var(--dx-line)" strokeWidth="2.5" strokeLinecap="round" opacity="0.35" />
            <line x1="-10" y1="20" x2="-20" y2="60" stroke="var(--dx-line)" strokeWidth="2" strokeLinecap="round" opacity="0.3" />
          </g>

          {/* Uses label */}
          <text x="580" y="172" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)" fontWeight="600">Required at:</text>
          <text x="580" y="190" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">sinks, desks, counters,</text>
          <text x="580" y="206" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-label)">dining surfaces</text>
          ...
          {CALLOUTS.map(c => (
            <g key={c.id} tabIndex="0" role="button" aria-label={`Callout ${c.id}: ${c.label}`} aria-expanded={active === c.id} onClick={() => toggle(c.id)} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); toggle(c.id); } }} style={{ cursor: 'pointer' }}>
              ...
              <circle cx={c.x} cy={c.y} r="22" fill="none" stroke="transparent" strokeWidth="2" className="knee-focus-ring" />
            </g>
          ))}
          <text x="20" y="438" fontFamily="var(--font-body)" fontSize="10" fill="var(--body-secondary)">Click or tap numbered callouts for details</text>
        </svg>
      </div>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Knee & Toe Clearance</p>
        <KeyFact color="var(--dx-violet)" number={d('27', '685')}>Minimum height for knee clearance at the front edge</KeyFact>
        <KeyFact color="var(--dx-green)" number={d('9', '230')}>Minimum height for toe clearance (below 9{'\u2033'} is the toe zone)</KeyFact>
        <KeyFact color="var(--dx-orange)" number={d('25', '635')}>Maximum total depth under the element (wall to front edge)</KeyFact>
        <KeyFact color="var(--dx-blue)" number={d('17', '430')}>Minimum depth for toe clearance</KeyFact>
        <KeyFact color="var(--dx-amber)" number={d('30', '760')}>Minimum width for both knee and toe clearance</KeyFact>
      </div>
      ...
      <style>{`
        ...
        g[role="button"]:focus .knee-fr{stroke:var(--accent);stroke-width:2.5} @media (prefers-reduced-motion: reduce) { .ada-diagram-wrap * { animation: none !important; transition: none !important; } }
      `}</style>
    </div>
  );
}
