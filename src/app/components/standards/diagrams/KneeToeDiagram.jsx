    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 450" role="group" aria-labelledby="knee-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="96" y="62" textAnchor="end" fontFamily="var(--font-body)" fontSize="10" fill="#94A3B8" fontWeight="600">wall</text>

          {/* Counter/desk surface */}
          <rect x="112" y="138" width="230" height="12" rx="3" fill="#94A3B8" stroke="#64748B" strokeWidth="1.5" />
          <text x="227" y="132" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">counter / desk surface</text>
          ...
          <text x="346" y="118" fontFamily="var(--font-body)" fontSize="10" fill="#94A3B8">front edge</text>

          {/* KNEE ZONE */}
          <path d="M 342 150 L 268 150 L 232 305 L 342 305 Z" fill="#7C3AED" opacity="0.06" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="310" y="230" fontFamily="var(--font-body)" fontSize="11" fill="#7C3AED" fontWeight="600" opacity="0.6">knee</text>
          <text x="310" y="245" fontFamily="var(--font-body)" fontSize="11" fill="#7C3AED" fontWeight="600" opacity="0.6">zone</text>

          {/* TOE ZONE */}
          <rect x="112" y="305" width="230" height="75" fill="#15803D" opacity="0.06" stroke="#15803D" strokeWidth="1.5" />
          <text x="227" y="348" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#15803D" fontWeight="600" opacity="0.6">toe zone</text>
          ...
          <text x="76" y="271" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="white">{d('27', '685')}</text>
          <text x="76" y="295" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C3AED" fontWeight="600">min high</text>

          {/* 9" toe height */}
          <rect x="42" y="332" width="52" height="20" rx="6" fill="#15803D" />
          <text x="68" y="346" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('9', '230')}</text>
          ...
          <text x="305" y="174" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('8', '205')} min</text>
          ...
          <text x="283" y="292" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('11', '280')} min</text>
          ...
          <text x="223" y="414" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('25', '635')} max</text>
          ...
          <text x="255" y="370" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('17', '430')} min</text>
          ...
          {/* Uses label */}
          <text x="580" y="172" fontFamily="var(--font-body)" fontSize="10" fill="#64748B" fontWeight="600">Required at:</text>
          <text x="580" y="190" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">sinks, desks, counters,</text>
          <text x="580" y="206" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">dining surfaces</text>
