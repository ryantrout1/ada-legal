    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="elev-cab-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="176" y="311" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('36', '915')} door min</text>
          ...
          <text x="170" y="345" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('68', '1730')} wide</text>
          ...
          <text x="341" y="181" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('51', '1295')}</text>
          <text x="341" y="198" fontFamily="var(--font-body)" fontSize="10" fill="#475569" fontWeight="600">deep</text>

          {/* Control panel on side wall */}
          <rect x="62" y="120" width="10" height="80" rx="2" fill="#15803D" opacity="0.2" stroke="#15803D" strokeWidth="1.5" />
          <text x="90" y="165" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">controls</text>
          ...
          <text x="550" y="95" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Buttons: {d('15', '380')}{'\u2013'}{d('48', '1220')} high</text>
          <text x="550" y="115" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">raised characters + Braille on every button</text>

          <rect x="410" y="148" width="280" height="60" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="550" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Floor numbers on both door jambs</text>
          <text x="550" y="193" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">raised characters + Braille, both sides</text>

          <rect x="410" y="226" width="280" height="60" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="550" y="251" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Emergency two-way communication</text>
          <text x="550" y="271" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">works without voice AND without vision</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 320" role="group" aria-labelledby="elev-sig-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="700">{'\u25b2'}</text>
          <text x="170" y="178" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6" fontWeight="700">{'\u25bc'}</text>
          ...
          <text x="241" y="165" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('42', '1065')} max</text>
          ...
          <text x="165" y="100" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#78350F" fontWeight="600">must show visible confirmation of call</text>
          ...
          <text x="540" y="93" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Visible: light or arrow shows direction</text>
          <text x="540" y="112" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">{d('2\u00bd', '64')} min character height</text>

          <rect x="400" y="142" width="280" height="55" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="540" y="165" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Audible: chimes announce direction</text>
          <text x="540" y="184" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">1 chime = up, 2 chimes = down</text>

          <rect x="400" y="214" width="280" height="55" rx="10" fill="#C2410C" opacity="0.04" stroke="#C2410C" strokeWidth="1.5" />
          <text x="540" y="237" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Door stays open long enough to enter</text>
          <text x="540" y="256" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">based on 1.5 ft/sec from call button to car</text>
