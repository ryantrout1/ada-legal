  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Inside the Cab</h2>
        {unitToggle}
      </div>
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="elev-cab-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">How big the cab must be</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">What must be inside</text>

          {/* LEFT: Cab plan view */}
          <rect x="60" y="80" width="230" height="200" rx="4" fill="var(--dx-orange)" opacity="0.03" stroke="var(--dx-line)" strokeWidth="2" />
          {/* Door opening at bottom */}
          <rect x="120" y="274" width="110" height="8" rx="1" fill="var(--page-bg-subtle)" />
          <line x1="120" y1="278" x2="120" y2="286" stroke="var(--dx-orange)" strokeWidth="2" />
          <line x1="230" y1="278" x2="230" y2="286" stroke="var(--dx-orange)" strokeWidth="2" />

          {/* Door width */}
          <line x1="120" y1="296" x2="230" y2="296" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <rect x="136" y="298" width="80" height="18" rx="5" fill="var(--dx-orange)" />
          <text x="176" y="311" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('36', '915')} door min</text>

          {/* Width dimension */}
          <line x1="60" y1="330" x2="290" y2="330" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="60" y1="325" x2="60" y2="335" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="290" y1="325" x2="290" y2="335" stroke="var(--dx-line)" strokeWidth="1.2" />
          <rect x="130" y="332" width="80" height="18" rx="5" fill="var(--dx-line)" />
          <text x="170" y="345" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('68', '1730')} wide</text>

          {/* Depth dimension */}
          <line x1="310" y1="80" x2="310" y2="280" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="305" y1="80" x2="315" y2="80" stroke="var(--dx-line)" strokeWidth="1.2" />
          <line x1="305" y1="280" x2="315" y2="280" stroke="var(--dx-line)" strokeWidth="1.2" />
          <rect x="316" y="168" width="50" height="18" rx="5" fill="var(--dx-line)" />
          <text x="341" y="181" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('51', '1295')}</text>
          <text x="341" y="198" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-line)" fontWeight="600">deep</text>

          {/* Control panel on side wall */}
          <rect x="62" y="120" width="10" height="80" rx="2" fill="var(--dx-green)" opacity="0.2" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="90" y="165" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">controls</text>

          {/* Wheelchair */}
          <g transform="translate(130,140) scale(0.65)" opacity="0.4">
            <rect x="0" y="0" width="50" height="40" rx="4" fill="none" stroke="var(--dx-line)" strokeWidth="2.5" />
            <circle cx="25" cy="20" r="8" fill="var(--dx-line)" stroke="var(--dx-line)" strokeWidth="2" />
          ...
          {/* DIVIDER */}
          <line x1="380" y1="40" x2="380" y2="340" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Controls & markings */}
          <rect x="410" y="70" width="280" height="60" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="550" y="95" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Buttons: {d('15', '380')}{'\u2013'}{d('48', '1220')} high</text>
          <text x="550" y="115" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">raised characters + Braille on every button</text>

          <rect x="410" y="148" width="280" height="60" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="550" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">Floor numbers on both door jambs</text>
          <text x="550" y="193" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)">raised characters + Braille, both sides</text>

          <rect x="410" y="226" width="280" height="60" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="550" y="251" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">Emergency two-way communication</text>
          <text x="550" y="271" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">works without voice AND without vision</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Inside the Cab</p>
        <KeyFact color="var(--dx-orange)" number={`${d('51', '1295')}\u00d7${d('68', '1730')}`}>Minimum cab size (center-opening door)</KeyFact>
        <KeyFact color="var(--dx-orange)" number={d('36', '915')}>Minimum door width (center-opening)</KeyFact>
        <KeyFact color="var(--dx-green)" number={`${d('15', '380')}\u2013${d('48', '1220')}`}>Control button height range</KeyFact>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '40px', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h2 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Buttons & Signals Outside</h2>
      </div>
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 320" role="group" aria-labelledby="elev-sig-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">Calling the elevator</text>
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">When the elevator arrives</text>

          {/* LEFT: Call buttons */}
          {/* Wall */}
          <rect x="140" y="60" width="12" height="220" rx="1" fill="var(--dx-line)" />
          {/* Button panel */}
          <rect x="155" y="140" width="30" height="50" rx="4" fill="var(--page-bg)" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <circle cx="170" cy="155" r="6" fill="var(--dx-violet)" opacity="0.2" stroke="var(--dx-violet)" strokeWidth="1" />
          <circle cx="170" cy="175" r="6" fill="var(--dx-violet)" opacity="0.2" stroke="var(--dx-violet)" strokeWidth="1" />
          <text x="170" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="700">{'\u25b2'}</text>
          <text x="170" y="178" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-violet)" fontWeight="700">{'\u25bc'}</text>

          {/* 42" max height */}
          <line x1="200" y1="140" x2="200" y2="280" stroke="var(--dx-violet)" strokeWidth="1.2" strokeDasharray="3 3" />
          <rect x="206" y="150" width="70" height="22" rx="6" fill="var(--dx-violet)" />
          <text x="241" y="165" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('42', '1065')} max</text>

          {/* Floor line */}
          <line x1="100" y1="280" x2="290" y2="280" stroke="var(--dx-label)" strokeWidth="2" />

          {/* Visible indicator note */}
          <rect x="50" y="80" width="230" height="35" rx="8" fill="var(--dx-amber)" opacity="0.04" stroke="var(--dx-amber)" strokeWidth="1.5" />
          <text x="165" y="100" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-amber)" fontWeight="600">must show visible confirmation of call</text>

          {/* DIVIDER */}
          <line x1="360" y1="40" x2="360" y2="300" stroke="var(--dx-line)" strokeWidth="1.5" strokeDasharray="6 4" />

          {/* RIGHT: Arrival signals */}
          <rect x="400" y="70" width="280" height="55" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="93" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Visible: light or arrow shows direction</text>
          <text x="540" y="112" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">{d('2\u00bd', '64')} min character height</text>

          <rect x="400" y="142" width="280" height="55" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="540" y="165" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">Audible: chimes announce direction</text>
          <text x="540" y="184" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">1 chime = up, 2 chimes = down</text>

          <rect x="400" y="214" width="280" height="55" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="540" y="237" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">Door stays open long enough to enter</text>
          <text x="540" y="256" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">based on 1.5 ft/sec from call button to car</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Buttons & Signals</p>
        <KeyFact color="var(--dx-violet)" number={d('42', '1065')}>Maximum height for hall call buttons</KeyFact>
        <KeyFact color="var(--dx-green)" number="See + Hear">Arrival signals must be both visible and audible</KeyFact>
        <KeyFact color="var(--dx-blue)" number="1 / 2">One chime for up, two chimes for down</KeyFact>
      </div>
      ...
      <style>{`
        ...
        g[role="button"]:focus .elev-fr { stroke: var(--accent); stroke-width: 2.5; } @media (prefers-reduced-motion: reduce) { .ada-diagram-wrap * { animation: none !important; transition: none !important; } }
      `}</style>
    </div>
  );
}
