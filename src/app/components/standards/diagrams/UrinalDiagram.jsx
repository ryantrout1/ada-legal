    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="ur-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="205" y="200" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">urinal</text>
          ...
          <text x="303" y="214" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('17', '430')} max</text>
          <text x="303" y="232" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">rim height</text>
          ...
          <text x="290" y="95" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">{d('44', '1120')} max</text>
          <text x="290" y="109" fontFamily="var(--font-body)" fontSize="10" fill="#15803D">flush controls</text>
          ...
          <text x="130" y="270" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">30{'\u2033'}{'\u00d7'}48{'\u2033'}</text>
          ...
          <text x="540" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#7C2D12" fontWeight="600">Rim no higher than {d('17', '430')}</text>
          <text x="540" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">stall-type (floor-length) preferred</text>

          <rect x="400" y="135" width="280" height="50" rx="10" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1.5" />
          <text x="540" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">Flush: one hand, {'\u2264'} 5 lbs or auto</text>
          <text x="540" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">manual controls at {d('44', '1120')} max</text>

          <rect x="400" y="200" width="280" height="50" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="540" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">30{'\u2033'} {'\u00d7'} 48{'\u2033'} clear floor space</text>
          <text x="540" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">forward approach, centered on urinal</text>

          <rect x="400" y="265" width="280" height="40" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="540" y="289" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Place at end of row for easier approach</text>
