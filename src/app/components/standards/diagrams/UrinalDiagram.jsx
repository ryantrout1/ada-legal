...
const CALLOUTS = [
  { id: 1, label: 'Height & Clear Space', section: '\u00a7605.2', color: 'var(--dx-orange)', textColor: 'var(--dx-orange)', x: 100, y: 52,
  ...
  { id: 2, label: 'Flush Controls & Shields', section: '\u00a7605.4', color: 'var(--dx-green)', textColor: 'var(--dx-green)', x: 470, y: 52,
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', flexWrap: 'wrap', gap: '8px' }}>
        <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>Accessible Urinal</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="ur-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="540" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="var(--body-secondary)">What to check</text>

          {/* LEFT: Side view */}
          {/* Wall */}
          <rect x="170" y="60" width="10" height="230" fill="var(--dx-line)" rx="2" />

          {/* Urinal */}
          <rect x="180" y="130" width="50" height="160" rx="4" fill="var(--dx-orange)" opacity="0.06" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="205" y="200" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">urinal</text>

          {/* Rim at 17" */}
          <line x1="180" y1="130" x2="250" y2="130" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <line x1="260" y1="130" x2="260" y2="290" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="254" y1="130" x2="266" y2="130" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <line x1="254" y1="290" x2="266" y2="290" stroke="var(--dx-orange)" strokeWidth="1.2" />
          <rect x="268" y="200" width="70" height="20" rx="6" fill="var(--dx-orange)" />
          <text x="303" y="214" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="var(--page-bg)">{d('17', '430')} max</text>
          <text x="303" y="232" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)" fontWeight="500">rim height</text>

          {/* Flush control */}
          <rect x="182" y="90" width="16" height="16" rx="3" fill="var(--dx-green)" opacity="0.15" stroke="var(--dx-green)" strokeWidth="1" />
          <line x1="210" y1="98" x2="260" y2="98" stroke="var(--dx-green)" strokeWidth="1" strokeDasharray="3 2" />
          <text x="290" y="95" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)" fontWeight="600">{d('44', '1120')} max</text>
          <text x="290" y="109" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">flush controls</text>

          {/* Floor */}
          <line x1="50" y1="290" x2="340" y2="290" stroke="var(--dx-label)" strokeWidth="2" />

          {/* Clear floor space */}
          <rect x="80" y="240" width="100" height="48" rx="2" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1" strokeDasharray="4 3" />
          <text x="130" y="270" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">30{'\u2033'}{'\u00d7'}48{'\u2033'}</text>
          ...
          {/* RIGHT: Checklist */}
          <rect x="400" y="70" width="280" height="50" rx="10" fill="var(--dx-orange)" opacity="0.04" stroke="var(--dx-orange)" strokeWidth="1.5" />
          <text x="540" y="92" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-orange)" fontWeight="600">Rim no higher than {d('17', '430')}</text>
          <text x="540" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-orange)">stall-type (floor-length) preferred</text>

          <rect x="400" y="135" width="280" height="50" rx="10" fill="var(--dx-green)" opacity="0.04" stroke="var(--dx-green)" strokeWidth="1.5" />
          <text x="540" y="157" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-green)" fontWeight="600">Flush: one hand, {'\u2264'} 5 lbs or auto</text>
          <text x="540" y="173" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-green)">manual controls at {d('44', '1120')} max</text>

          <rect x="400" y="200" width="280" height="50" rx="10" fill="var(--dx-blue)" opacity="0.04" stroke="var(--dx-blue)" strokeWidth="1.5" />
          <text x="540" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-blue)" fontWeight="600">30{'\u2033'} {'\u00d7'} 48{'\u2033'} clear floor space</text>
          <text x="540" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="var(--dx-blue)">forward approach, centered on urinal</text>

          <rect x="400" y="265" width="280" height="40" rx="10" fill="var(--dx-violet)" opacity="0.04" stroke="var(--dx-violet)" strokeWidth="1.5" />
          <text x="540" y="289" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="var(--dx-violet)" fontWeight="600">Place at end of row for easier approach</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', padding: '20px 24px', marginTop: '12px' }}>
        <p style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 12px' }}>Key numbers {'\u2014'} Urinals</p>
        <KeyFact color="var(--dx-orange)" number={`\u2264 ${d('17', '430')}`}>Maximum rim height above floor</KeyFact>
        <KeyFact color="var(--dx-green)" number={`\u2264 ${d('44', '1120')}`}>Maximum height for manual flush controls</KeyFact>
        <KeyFact color="var(--dx-blue)" number={`30\u2033\u00d748\u2033`}>Clear floor space for forward approach</KeyFact>
      </div>
