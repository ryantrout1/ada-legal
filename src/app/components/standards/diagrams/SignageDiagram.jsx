    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="img" aria-labelledby="sig-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="102" y="200" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#94A3B8">door</text>

          {/* Sign on latch side */}
          <rect x="140" y="150" width="80" height="60" rx="6" fill="#C2410C" opacity="0.08" stroke="#C2410C" strokeWidth="2" />
          <text x="180" y="172" textAnchor="middle" fontFamily="var(--font-body)" fontSize="14" fill="#7C2D12" fontWeight="700">205</text>
          <text x="180" y="192" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12">raised + Braille</text>
          ...
          <text x="291" y="244" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">{d('48', '1220')}{'\u2013'}{d('60', '1525')}</text>
          <text x="291" y="264" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="500">mounting height</text>

          {/* Latch side note */}
          <text x="180" y="130" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="600">latch side of door</text>

          {/* Requirements */}
          <text x="180" y="280" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">raised letters + Grade 2 Braille</text>
          <text x="180" y="296" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#64748B">sans serif, uppercase, high contrast</text>
          ...
          <text x="540" y="105" textAnchor="middle" fontFamily="var(--font-body)" fontSize="16" fill="#14532D" fontWeight="700">Restrooms {'\u2192'}</text>
          <text x="540" y="122" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D">large text, high contrast, non-glare</text>

          {/* No Braille needed */}
          <rect x="430" y="150" width="220" height="32" rx="8" fill="#15803D" opacity="0.04" stroke="#15803D" strokeWidth="1" />
          <text x="540" y="170" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#14532D" fontWeight="600">No Braille needed on directional signs</text>

          {/* Size by distance */}
          <rect x="430" y="200" width="220" height="48" rx="8" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1" />
          <text x="540" y="220" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#1E3A8A" fontWeight="600">Text size based on viewing distance</text>
          <text x="540" y="238" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">{'\u2265'} 5/8{'\u2033'} for under 6 feet, larger for farther</text>

          {/* Accessibility symbol */}
          <rect x="430" y="266" width="220" height="48" rx="8" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1" />
          <text x="540" y="286" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fill="#5B21B6" fontWeight="600">Accessibility symbol required</text>
          <text x="540" y="304" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">on signs for accessible facilities</text>
