    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 380" role="group" aria-labelledby="rules-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="170" y="88" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#C2410C" fontWeight="600">too high</text>
          ...
          <text x="297" y="117" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="white">{d('48', '1220')}</text>
          ...
          <text x="297" y="305" textAnchor="middle" fontFamily="var(--font-body)" fontSize="11" fontWeight="700" fill="white">{d('15', '380')}</text>
          ...
          <text x="120" y="222" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">switch</text>

          {/* Thermostat */}
          <rect x="155" y="165" width="30" height="30" rx="6" fill="white" stroke="#15803D" strokeWidth="1.5" />
          <text x="170" y="184" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">72{'\u00b0'}</text>
          <text x="170" y="212" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">thermostat</text>

          {/* Outlet */}
          <rect x="210" y="255" width="22" height="30" rx="3" fill="white" stroke="#15803D" strokeWidth="1.5" />
          <text x="221" y="300" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#15803D" fontWeight="600">outlet</text>
          ...
          <text x="420" y="98" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#14532D">One-hand operation</text>
          <text x="420" y="116" fontFamily="var(--font-body)" fontSize="10" fill="#14532D">Must work with a single hand</text>
          <text x="666" y="108" textAnchor="middle" fontFamily="var(--font-body)" fontSize="22" fill="#15803D" opacity="0.3">{'\u270b'}</text>

          <rect x="400" y="156" width="280" height="72" rx="10" fill="#7C3AED" opacity="0.04" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="420" y="184" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#5B21B6">No grasping, pinching, twisting</text>
          <text x="420" y="202" fontFamily="var(--font-body)" fontSize="10" fill="#5B21B6">Round doorknobs fail this test</text>
          <text x="666" y="194" textAnchor="middle" fontFamily="var(--font-body)" fontSize="22" fill="#7C3AED" opacity="0.3">{'\u21bb'}</text>

          <rect x="400" y="242" width="280" height="72" rx="10" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1.5" />
          <text x="420" y="270" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#1E3A8A">{'\u2264'} 5 pounds of force</text>
          <text x="420" y="288" fontFamily="var(--font-body)" fontSize="10" fill="#1E3A8A">No stiff switches or heavy push mechanisms</text>
          <rect x="640" y="266" width="46" height="22" rx="6" fill="#2563EB" />
          <text x="663" y="281" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fontWeight="700" fill="white">5 lbs</text>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 720 340" role="group" aria-labelledby="types-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* LEFT: PASS */}
          <text x="170" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#15803D">These pass {'\u2714'}</text>
          ...
          <text x="85" y="135" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Lever handle</text>
          <text x="85" y="150" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" textAnchor="middle">push down to open</text>
          ...
          <text x="175" y="135" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Rocker switch</text>
          <text x="175" y="150" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" textAnchor="middle">press up or down</text>
          ...
          <text x="260" y="135" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Push button</text>
          <text x="260" y="150" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" textAnchor="middle">press with palm or fist</text>
          ...
          <text x="90" y="243" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Paddle faucet</text>
          <text x="90" y="258" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" textAnchor="middle">push with wrist</text>

          {/* Touch/sensor */}
          <rect x="160" y="185" width="55" height="40" rx="6" fill="#15803D" opacity="0.06" stroke="#15803D" strokeWidth="1.5" />
          <text x="188" y="210" textAnchor="middle" fontFamily="var(--font-body)" fontSize="14" fill="#15803D" opacity="0.4">{'\u2728'}</text>
          <text x="188" y="243" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" fontWeight="600">Sensor</text>
          <text x="188" y="258" fontFamily="var(--font-body)" fontSize="10" fill="#14532D" textAnchor="middle">no touch needed</text>
          ...
          {/* RIGHT: FAIL */}
          <text x="560" y="30" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fontWeight="700" fill="#C2410C">These fail {'\u2718'}</text>
          ...
          <text x="420" y="130" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" fontWeight="600">Round knob</text>
          <text x="420" y="144" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" textAnchor="middle">wrist twist</text>

          {/* Twist faucet */}
          <rect x="505" y="72" width="50" height="42" rx="6" fill="#C2410C" opacity="0.06" stroke="#C2410C" strokeWidth="1.5" />
          <text x="530" y="98" textAnchor="middle" fontFamily="var(--font-body)" fontSize="12" fill="#C2410C" opacity="0.4">{'\u21bb'}</text>
          <text x="530" y="130" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" fontWeight="600">Twist faucet</text>
          <text x="530" y="144" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" textAnchor="middle">grip + rotate</text>
          ...
          <text x="640" y="130" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" fontWeight="600">Thumb-turn</text>
          <text x="640" y="144" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" textAnchor="middle">pinch + twist</text>
          ...
          <text x="430" y="233" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" fontWeight="600">Tiny toggle</text>
          <text x="430" y="247" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" textAnchor="middle">fingertip pinch</text>
          ...
          <text x="540" y="233" textAnchor="middle" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" fontWeight="600">Stiff valve</text>
          <text x="540" y="247" fontFamily="var(--font-body)" fontSize="10" fill="#7C2D12" textAnchor="middle">{"> 5 lbs force"}</text>
