 ...
 * thought", never "a barrier shut me out" — Ada remains the only front
 * door for that. The message prompt is deliberately not situational.
 */
    ...
    try {
      await fetch('/api/public/feedback', {
        ...
        body: JSON.stringify({
          ...
          page: capturedRef.current.page_name,
