...
export const PACKAGE_DISCLAIMER =
  'This summary is generated by Ada, an AI assistant. It is not legal advice, and Ada is not a lawyer. ' +
  'Before you take any formal action — filing a complaint, sending a demand letter, or contacting an attorney — ' +
  'please review what Ada has written for accuracy and talk to a qualified attorney if you have one available. ' +
  'The information here reflects what you told Ada during the conversation and may not include everything a lawyer would want to know.';
