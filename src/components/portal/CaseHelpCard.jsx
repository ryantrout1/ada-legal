...
export default function CaseHelpCard({ caseId }) {
  ...
  return (
    <div style={{
      backgroundColor: 'var(--heading)', borderRadius: '12px', padding: '24px',
      color: 'white'
    }}>
      <h2 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.1rem', fontWeight: 600, color: 'white', margin: '0 0 8px' }}>
        Questions about your case?
      </h2>
      <p style={{ fontFamily: 'Manrope, sans-serif', fontSize: '0.9rem', color: 'var(--body-secondary)', margin: '0 0 16px', lineHeight: 1.5 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px', flexWrap: 'wrap' }}>
        ...
        <button type="button" onClick={handleCopy} style={{
          ...
          fontWeight: 600, color: 'var(--body-secondary)',
