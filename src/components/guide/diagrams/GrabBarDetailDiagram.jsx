...
const CALLOUTS = [
  {
    id: 1, label: 'Circular Profile', section: '§609.2.1', color: '#C2410C',
    x: 120, y: 42,
  ...
  {
    id: 2, label: 'Non-Circular Profile', section: '§609.2.2', color: '#16A34A',
    x: 310, y: 42,
  ...
  {
    id: 3, label: 'Wall Clearance', section: '§609.3', color: '#2563EB',
    x: 120, y: 260,
  ...
  {
    id: 4, label: 'Mounting Height', section: '§609.4', color: '#7C3AED',
    x: 620, y: 42,
  ...
  {
    id: 5, label: 'Structural Strength', section: '§609.8', color: '#D97706',
    x: 810, y: 42,
  ...
  {
    id: 6, label: 'Hazards', section: '§609.5', color: '#DB2777',
    x: 620, y: 190,
  ...
  {
    id: 7, label: 'Fittings', section: '§609.6 / §609.7', color: '#0EA5E9',
    x: 810, y: 190,
...
function makeLink(text) {
  return (<a href={GRAB_URL} target="_blank" rel="noopener noreferrer" style={{ color: '#C2410C', textDecoration: 'none', borderBottom: '1px dotted #C2410C' }} aria-label={`${text} on ADA.gov`}>{text}<span aria-hidden="true" style={{ fontSize: '0.65em', marginLeft: '1px', verticalAlign: 'super' }}>↗</span></a>);
}
    ...
    <div style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 900 320" role="img" aria-labelledby="grab-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* (B) Non-Circular */}
          <text x="310" y="68" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fontWeight="700" fill="#16A34A">(B) NON-CIRCULAR</text>
          {/* Wall */}
          ...
          {/* (C) Clearance detail */}
          <text x="215" y="218" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fontWeight="700" fill="#2563EB">(C) WALL CLEARANCE DETAIL</text>
          ...
          <text x="260" y="255" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB">No sharp/abrasive</text>
          <text x="260" y="268" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB">elements in gap</text>
          ...
          <text x="660" y="60" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#D97706" fontWeight="600">BLOCKING / REINFORCEMENT</text>
          ...
          <text x="660" y="144" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#7C3AED" fontWeight="700">GRAB BAR</text>
          ...
          <text x="830" y="133" fontFamily="Manrope, sans-serif" fontSize="6" fill="#DB2777" fontWeight="500">{d('1.5', '38')}↑</text>
          ...
          <text x="830" y="196" fontFamily="Manrope, sans-serif" fontSize="6" fill="#0EA5E9" fontWeight="500">{d('12', '305')}↓</text>

          <text x="660" y="236" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#0EA5E9">Clear zone: {d('1.5', '38')} above, {d('12', '305')} below</text>
      ...
      <style>{`@keyframes grabFade { from { opacity:0; transform:translateY(-8px); } to { opacity:1; transform:translateY(0); } }`}</style>
    </div>
  );
}