...
const CALLOUTS = [
  ...
  { id: 2, label: 'Access Aisle', section: '§503.3', color: '#16A34A', textColor: '#14532D', x: 300, y: 42, plain: 'An access aisle 60 inches (5 feet) wide minimum and 20 feet long minimum must run alongside the pull-up space. The aisle must be at the same level as the vehicle floor — no curb between the aisle and the pull-up space. The aisle must connect directly to an accessible route leading to the building entrance.', legal: '"Access aisles serving passenger loading zones shall be 60 inches wide minimum and 20 feet long minimum, at the same level as the vehicle pull-up space."', citation: '§503.3' },
