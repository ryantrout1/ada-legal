...
const CALLOUTS = [
  { id: 1, label: 'Mounting Location', section: '§703.4.1', color: '#C2410C', x: 80, y: 42,
    ...
    citation: '§703.4.1' },
  { id: 2, label: 'Mounting Height', section: '§703.4.1', color: '#16A34A', x: 280, y: 42,
    ...
    citation: '§703.4.1' },
  { id: 3, label: 'Raised Characters', section: '§703.2', color: '#2563EB', x: 480, y: 42,
    ...
    citation: '§703.2' },
  { id: 4, label: 'Braille', section: '§703.3', color: '#7C3AED', x: 80, y: 250,
    ...
    citation: '§703.3' },
  { id: 5, label: 'Finish & Contrast', section: '§703.5', color: '#D97706', x: 280, y: 250,
    ...
    citation: '§703.5' },
  { id: 6, label: 'Visual Characters', section: '§703.5', color: '#DB2777', x: 480, y: 250,
    ...
    citation: '§703.5' },
  { id: 7, label: 'Pictograms', section: '§703.6', color: '#0EA5E9', x: 680, y: 140,
...
function makeLink(t) { return (<a href={SIGN_URL} target="_blank" rel="noopener noreferrer" style={{ color: '#C2410C', textDecoration: 'none', borderBottom: '1px dotted #C2410C' }}>{t}<span aria-hidden="true" style={{ fontSize: '0.65em', marginLeft: '1px', verticalAlign: 'super' }}>↗</span></a>); }
    ...
    <div style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 900 480" role="img" aria-labelledby="sign-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* MAIN VIEW: Door + Sign */}
          <text x="250" y="28" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="10" fontWeight="700" fill="#94A3B8" letterSpacing=".08em">WALL ELEVATION</text>
          {/* Wall */}
          ...
          <text x="200" y="70" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#94A3B8">DOOR</text>
          {/* Door frame */}
          ...
          {/* Latch side label */}
          <text x="350" y="70" fontFamily="Manrope, sans-serif" fontSize="7" fill="#C2410C" fontWeight="600">LATCH SIDE →</text>
          ...
          <text x="370" y="305" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#94A3B8">BRAILLE</text>
          ...
          <text x="640" y="28" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="10" fontWeight="700" fill="#94A3B8" letterSpacing=".08em">DETAIL INSETS</text>
          <rect x="530" y="45" width="180" height="160" rx="8" fill="white" stroke="#2563EB" strokeWidth="1.5" />
          <text x="620" y="62" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fontWeight="700" fill="#2563EB">(A) RAISED CHARACTERS</text>
          {/* Sample character */}
          ...
          <text x="548" y="120" textAnchor="end" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#2563EB" fontWeight="600">{d('⅝–2', '16–50')}</text>
          {/* Raised detail */}
          <text x="620" y="170" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB">Uppercase · Sans Serif · Raised 1/32" min</text>
          <text x="620" y="195" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#94A3B8">High contrast with background</text>

          {/* INSET B: Braille */}
          <rect x="530" y="220" width="180" height="160" rx="8" fill="white" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="620" y="237" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fontWeight="700" fill="#7C3AED">(B) GRADE 2 BRAILLE</text>
          ...
          <text x="650" y="273" fontFamily="Manrope, sans-serif" fontSize="5.5" fill="#D97706" fontWeight="600">← 0.090–0.100"</text>
          {/* Dot size */}
          <text x="620" y="345" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#7C3AED">Dome Ø 0.059–0.063" · 3/8" min below text</text>
          <text x="620" y="370" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#94A3B8">Grade 2 contracted Braille</text>

          {/* PICTOGRAM note */}
          <rect x="730" y="90" width="150" height="110" rx="8" fill="#0EA5E9" opacity="0.04" stroke="#0EA5E9" strokeWidth="1" />
          <text x="805" y="110" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fontWeight="700" fill="#0EA5E9">PICTOGRAM</text>
          ...
          <text x="805" y="195" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#0EA5E9">{d('6', '150')} min field height</text>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: '12px', background: 'white', border: '1px solid var(--slate-200)', borderRadius: '12px', overflow: 'hidden', animation: 'signFade .25s ease-out' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px', borderBottom: '1px solid var(--slate-200)', background: '#FAFAF9', flexWrap: 'wrap', gap: '8px' }}>
            ...
            <button onClick={() => setActive(null)} aria-label="Close" style={{ background: 'none', border: '1px solid var(--slate-200)', borderRadius: '6px', padding: '4px 10px', cursor: 'pointer', fontFamily: 'Manrope, sans-serif', fontSize: '0.75rem', color: 'var(--slate-500)', minHeight: 30 }}>Close ✕</button>
          </div>
      ...
      <style>{`@keyframes signFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}