...
const CALLOUTS = [
  { id: 1, label: 'Mounting Location', section: '§703.4.1', color: '#C2410C', textColor: '#8B2E08', x: 80, y: 42,
    ...
    citation: '§703.4.1' },
  { id: 2, label: 'Mounting Height', section: '§703.4.1', color: '#15803D', textColor: '#14532D', x: 280, y: 42,
  ...
  { id: 4, label: 'Braille', section: '§703.3', color: '#7C3AED', textColor: '#5B21B6', x: 80, y: 250,
    ...
    citation: '§703.3' },
  { id: 5, label: 'Finish & Contrast', section: '§703.5', color: '#92400E', textColor: '#78350F', x: 280, y: 250,
    ...
    citation: '§703.5' },
  { id: 6, label: 'Visual Characters', section: '§703.5', color: '#BE185D', textColor: '#9D174D', x: 480, y: 250,
    ...
    citation: '§703.5' },
  { id: 7, label: 'Pictograms', section: '§703.6', color: '#0E7490', textColor: '#0C4A6E', x: 680, y: 140,
    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden' }}>
        <svg viewBox="0 0 900 480" role="img" aria-labelledby="sign-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <rect x="320" y="195" width="100" height="120" rx="6" fill="var(--dark-bg)" stroke="#64748B" strokeWidth="1.5" />
          {/* Room number on sign */}
          ...
          {/* Sample character */}
          <rect x="570" y="80" width="100" height="70" rx="4" fill="var(--dark-bg)" />
          ...
          <rect x="565" y="250" width="110" height="80" rx="4" fill="var(--dark-bg)" />
          {/* Enlarged dots */}
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: '12px', background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: '12px', overflow: 'hidden', animation: 'signFade .25s ease-out' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '14px 20px', borderBottom: '1px solid var(--border)', background: 'var(--page-bg-subtle)', flexWrap: 'wrap', gap: '8px' }}>
            ...
            <button onClick={() => setActive(null)} aria-label="Close" style={{ background: 'none', border: '1px solid var(--border)', borderRadius: '8px', padding: '8px 16px', cursor: 'pointer', fontFamily: 'Manrope, sans-serif', fontSize: '0.875rem', fontWeight: 600, color: 'var(--body)', minHeight: 44 }}>Close <span aria-hidden="true">✕</span></button>
          </div>
