  ...
  return (
    <div style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--slate-900)', margin: 0 }}>§309 Operable Parts</h3>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 480" role="img" aria-labelledby="op-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="300" y="380" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#16A34A" fontWeight="600">COMPLIANT ZONE: {d('15', '380')} – {d('48', '1220')}</text>
          ...
          <text x="165" y="285" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED" fontWeight="600">Lever ✓</text>
          {/* Rocker switch */}
          ...
          <text x="235" y="305" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED" fontWeight="600">Rocker ✓</text>
          {/* Push button */}
          ...
          <text x="300" y="290" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED" fontWeight="600">Push ✓</text>
          {/* Outlet */}
          <rect x="355" y="320" width="30" height="40" rx="3" fill="#7C3AED" opacity="0.1" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="370" y="375" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED" fontWeight="600">Outlet ✓</text>
          ...
          <text x="430" y="204" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#D97706" fontWeight="600">KNOB</text>
          <text x="430" y="230" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#D97706">✕ Twist required</text>

          {/* 5 lbs max label */}
          <rect x="330" y="168" width="80" height="20" rx="4" fill="#2563EB" opacity="0.06" stroke="#2563EB" strokeWidth="1" />
          <text x="370" y="182" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB" fontWeight="600">≤ 5 lbs force</text>
          ...
          <rect x="560" y="70" width="170" height="130" rx="8" fill="#0EA5E9" opacity="0.04" stroke="#0EA5E9" strokeWidth="1" />
          <text x="645" y="90" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#0EA5E9" fontWeight="700">COMMON APPLICATIONS</text>
          {['Light switches', 'Thermostats', 'Fire alarm pulls', 'Faucets & dispensers', 'Door hardware', 'Elevator buttons', 'Window locks'].map((t, i) => (
            <text key={i} x="575" y={108 + i * 13} fontFamily="Manrope, sans-serif" fontSize="7" fill="#0EA5E9">• {t}</text>
          ))}
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden', animation: 'opFade .25s ease-out' }}>
      ...
      <style>{`@keyframes opFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}