  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>§410 Platform Lifts</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="pl-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="388" y="275" fontFamily="Manrope, sans-serif" fontSize="7" fill="#5B21B6" fontWeight="500">TRAVEL</text>

          {/* Door opening at upper level */}
          <line x1="240" y1="120" x2="240" y2="170" stroke="#2563EB" strokeWidth="2.5" />
          <text x="225" y="150" textAnchor="end" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#1E3A8A" fontWeight="600">DOOR</text>
          ...
          <text x="670" y="396" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#1E3A8A" fontWeight="600">DOOR OPENING</text>

          {/* Clear floor space */}
          <rect x="570" y="170" width="200" height="180" rx="4" fill="#C2410C" opacity="0.05" stroke="#C2410C" strokeWidth="1.5" strokeDasharray="6 3" />
          <text x="670" y="265" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#8B2E08" fontWeight="600">CLEAR FLOOR</text>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', animation: 'plFade .25s ease-out' }}>
      ...
      <style>{`@keyframes plFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}        @media (prefers-reduced-motion: reduce) {
