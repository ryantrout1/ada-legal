    ...
    <div style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="tr-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="220" y="235" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#C2410C" fontWeight="600">BOARDING AREA</text>
          ...
          <text x="140" y="360" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#16A34A" fontWeight="600">BUS SHELTER</text>
          ...
          <text x="140" y="394" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#16A34A">{d('30', '760')}×{d('48', '1220')} clear</text>

          {/* Accessible route arrow */}
          <line x1="200" y1="295" x2="150" y2="330" stroke="#0EA5E9" strokeWidth="1.5" markerEnd="url(#trArr)" />
          <text x="190" y="320" fontFamily="Manrope, sans-serif" fontSize="6" fill="#0EA5E9" fontWeight="600">Route</text>
          ...
          <text x="685" y="265" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB" fontWeight="600">DETECTABLE WARNINGS — {d('24', '610')} deep</text>

          {/* Track/gap */}
          <rect x="500" y="310" width="370" height="20" fill="#7C3AED" opacity="0.04" />
          <text x="685" y="324" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#7C3AED">GAP</text>
          ...
          <text x="680" y="323" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED" fontWeight="600">3" max goal</text>
          ...
          <text x="810" y="200" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#D97706" fontWeight="600">STATION SIGN</text>
          <text x="810" y="212" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#D97706">Raised chars</text>
          <text x="810" y="222" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#D97706">+ Braille per §703</text>

          {/* Accessible route arrow */}
          <line x1="530" y1="450" x2="530" y2="315" stroke="#0EA5E9" strokeWidth="1.5" markerEnd="url(#trArr2)" />
          <text x="545" y="450" fontFamily="Manrope, sans-serif" fontSize="7" fill="#0EA5E9" fontWeight="600">Accessible Route</text>
          <text x="545" y="462" fontFamily="Manrope, sans-serif" fontSize="6" fill="#0EA5E9">from entrance</text>
      ...
      <style>{`@keyframes trFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}