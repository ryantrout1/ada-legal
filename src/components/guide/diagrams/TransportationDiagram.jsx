...
const CALLOUTS = [
  ...
  { id: 5, label: 'Signage & Information', section: '§810.6', color: '#92400E', textColor: '#78350F', x: 350, y: 340, plain: 'Route maps, timetables, and fare information displayed at stations must comply with §703 signage requirements where applicable. Station names must be provided in raised characters and Braille at each station. Real-time arrival information, where provided, should include both visual and audible formats.', legal: '"Station signs shall comply with 703." Per §810.6: route identification signage at stations.', citation: '§810.6, §703' },
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>§810 Transportation Facilities</h3>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', animation: 'trFade .25s ease-out' }}>
