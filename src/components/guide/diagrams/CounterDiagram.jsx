...
const CALLOUTS = [
  { id: 1, label: 'Checkout Aisle Width', section: '§904.3', color: 'var(--section-label)', textColor: '#8B2E08', x: 100, y: 42,
    ...
    citation: '§904.3' },
  { id: 2, label: 'Sales Counter Height', section: '§904.4', color: '#15803D', textColor: '#14532D', x: 300, y: 42,
    ...
    citation: '§904.4' },
  { id: 3, label: 'Service Counter', section: '§904.4.1', color: '#2563EB', textColor: '#1E3A8A', x: 500, y: 42,
    ...
    citation: '§904.4.1' },
  { id: 4, label: 'Food Service Lines', section: '§904.5', color: '#7C3AED', textColor: '#5B21B6', x: 100, y: 260,
    ...
    citation: '§904.5' },
  { id: 5, label: 'Approach', section: '§904.3.1', color: '#92400E', textColor: '#78350F', x: 300, y: 260,
    ...
    citation: '§904.3.1' },
  { id: 6, label: 'Counter Edge', section: 'Advisory §904', color: '#BE185D', textColor: '#9D174D', x: 500, y: 260,
    ...
    citation: '§904' },
  { id: 7, label: 'Scoping', section: '§227', color: '#0E7490', textColor: '#0C4A6E', x: 700, y: 150,
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>§904 Sales & Service Counters</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 420" role="img" aria-labelledby="ctr-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="620" y="233" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#1E3A8A" fontWeight="700">(B) SERVICE</text>
          {/* Knee clearance zone */}
          <rect x="565" y="253" width="110" height="122" rx="2" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="0.8" strokeDasharray="3 2" />
          <text x="620" y="325" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#1E3A8A">Knee clearance</text>
          ...
          <text x="770" y="242" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#5B21B6" fontWeight="700">(C) FOOD SERVICE</text>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', animation: 'ctrFade .25s ease-out' }}>
      ...
      <style>{`@keyframes ctrFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}        @media (prefers-reduced-motion: reduce) {
