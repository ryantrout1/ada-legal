...
const CALLOUTS = [
  { id: 1, label: 'Checkout Aisle Width', section: '§904.3', color: '#C2410C', textColor: '#8B2E08', x: 100, y: 42,
    ...
    citation: '§904.3' },
  { id: 2, label: 'Sales Counter Height', section: '§904.4', color: '#16A34A', textColor: '#14532D', x: 300, y: 42,
  ...
  { id: 4, label: 'Food Service Lines', section: '§904.5', color: '#7C3AED', textColor: '#5B21B6', x: 100, y: 260,
    ...
    citation: '§904.5' },
  { id: 5, label: 'Approach', section: '§904.3.1', color: '#D97706', textColor: '#78350F', x: 300, y: 260,
    ...
    citation: '§904.3.1' },
  { id: 6, label: 'Counter Edge', section: 'Advisory §904', color: '#DB2777', textColor: '#9D174D', x: 500, y: 260,
