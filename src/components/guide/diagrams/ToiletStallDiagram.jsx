...
const LAYOUT_CALLOUTS = [
  { id: 1, label: 'Stall Size & Toilet Position', section: '\u00a7604.8', color: '#C2410C', textColor: '#7C2D12', x: 170, y: 52,
  ...
  { id: 2, label: 'Grab Bars & Accessories', section: '\u00a7604.5', color: '#15803D', textColor: '#14532D', x: 540, y: 52,
