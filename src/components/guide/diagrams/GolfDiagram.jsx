    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="gf-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="95" y="270" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#16A34A" fontWeight="600" transform="rotate(-90,95,270)">ACCESSIBLE ROUTE — {d('36', '915')} min</text>

          {/* Hole 1 (accessible) */}
          <rect x="130" y="70" width="280" height="120" rx="8" fill="#C2410C" opacity="0.04" stroke="#C2410C" strokeWidth="1.5" />
          <text x="270" y="95" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#C2410C" fontWeight="600">HOLE 1 (Accessible)</text>
          {/* Start of play area */}
          <rect x="135" y="110" width="100" height="70" rx="4" fill="#2563EB" opacity="0.05" stroke="#2563EB" strokeWidth="1.5" strokeDasharray="4 2" />
          <text x="185" y="140" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB" fontWeight="600">START OF PLAY</text>
          <text x="185" y="155" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB">{d('48', '1220')} × {d('60', '1525')}</text>
          {/* Golf hole */}
          ...
          <text x="320" y="170" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="5.5" fill="#16A34A">turf/carpet surface OK</text>
          ...
          <text x="270" y="360" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#C2410C" fontWeight="600">LAST HOLE (Accessible)</text>

          {/* 50% note */}
          <rect x="130" y="465" width="280" height="20" rx="4" fill="#C2410C" opacity="0.05" />
          <text x="270" y="479" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#C2410C" fontWeight="600">≥ 50% of holes must be accessible (incl. first & last)</text>

          {/* RIGHT: Golf course */}
          {/* Teeing ground */}
          <rect x="510" y="60" width="340" height="200" rx="20" fill="#7C3AED" opacity="0.03" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="680" y="90" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#7C3AED" fontWeight="600">TEEING GROUND</text>

          {/* Tee boxes */}
          <rect x="560" y="120" width="60" height="30" rx="6" fill="#7C3AED" opacity="0.06" stroke="#7C3AED" strokeWidth="1" />
          <text x="590" y="139" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED">TEE 1 ✓</text>
          ...
          <text x="680" y="295" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#D97706" fontWeight="600">GOLF CAR PASSAGE — {d('48', '1220')} wide min (serves as accessible route)</text>

          {/* Putting green */}
          <ellipse cx="680" cy="370" rx="140" ry="60" fill="#16A34A" opacity="0.04" stroke="#16A34A" strokeWidth="1" />
          <text x="680" y="375" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#16A34A" fontWeight="600">PUTTING GREEN</text>
          ...
          <text x="780" y="465" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#0EA5E9" fontWeight="600">WEATHER SHELTER</text>
          <text x="780" y="480" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#0EA5E9">Accessible route required</text>
      ...
      <style>{`@keyframes gfFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}