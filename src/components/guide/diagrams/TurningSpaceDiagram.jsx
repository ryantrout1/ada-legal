...
export default function TurningSpaceDiagram() {
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      {activeCallout && (
        <div ref={panelRef} style={{ marginTop: '12px', background: 'white', border: '1px solid var(--slate-200)', borderRadius: '12px', overflow: 'hidden', animation: 'turnFade 0.25s ease-out' }}>
