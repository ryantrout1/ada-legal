...
const CALLOUTS = [
  { id: 1, label: 'System Types', section: '§706.2', color: '#C2410C', x: 120, y: 100, plain: 'Assistive listening systems may use induction loop, FM, infrared, or digital technology. Induction loop is preferred for hearing aid users because it works directly with the T-coil in hearing aids — no separate receiver needed. FM and infrared require handheld receivers.', legal: '"Assistive listening systems shall comply with §706." Systems include induction loop, FM, infrared, or other approved technologies.', citation: '§706.2' },
  { id: 2, label: 'Signal-to-Noise Ratio', section: '§706.3', color: '#16A34A', x: 350, y: 100, plain: 'The system must provide a minimum 18 dB signal-to-noise ratio improvement. This ensures that spoken audio is clearly audible above ambient background noise. The system must cover the entire seating area uniformly.', legal: '"The signal-to-noise ratio for the assistive listening system shall be not less than 18 dB." Coverage area must be the entire seating area.', citation: '§706.3' },
  { id: 3, label: 'Receivers', section: '§706.2', color: '#2563EB', x: 580, y: 100, plain: 'The number of receivers is based on the seating capacity (per §219.3 table). At least 25% of receivers must be hearing-aid compatible (neckloops that work with T-coils). The remaining 75% can be standard receivers with earbuds or headphones.', legal: '"At least 25 percent, but no fewer than two, of the receivers shall be hearing-aid compatible." Remaining receivers: standard earbuds/headphones.', citation: '§706.2, §219.3' },
  { id: 4, label: 'Signage', section: '§706.4', color: '#7C3AED', x: 120, y: 340, plain: 'The International Symbol of Access for Hearing Loss must be posted at each assembly area where an assistive listening system is provided. The sign must indicate that the system is available and where to obtain receivers.', legal: '"Each assembly area required to provide an assistive listening system shall provide signs informing patrons of the availability of the system." Sign: International Symbol of Access for Hearing Loss per §703.7.2.4.', citation: '§706.4' },
  { id: 5, label: 'Scoping', section: '§219.2', color: '#D97706', x: 350, y: 340, plain: 'Assistive listening systems are required in assembly areas with audio amplification. Areas with 50 or more fixed seats must follow the scoping table. Courtrooms always require them. Areas under 50 seats are generally not required to have ALS unless audio amplification is integral to the space\'s use.', legal: '§219.2: "In each assembly area where audible communication is integral to the use of the space, an assistive listening system shall be provided." Scoping per Table 219.3.', citation: '§219.2' }
];
    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="als-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="450" y="185" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#C2410C" fontWeight="600">INDUCTION LOOP / COVERAGE ZONE</text>
          ...
          <text x="450" y="152" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#16A34A" fontWeight="600">18 dB S/N ratio min</text>

          {/* Receiver station */}
          <rect x="730" y="440" width="140" height="50" rx="8" fill="#2563EB" opacity="0.05" stroke="#2563EB" strokeWidth="1" />
          <text x="800" y="460" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB" fontWeight="600">RECEIVER STATION</text>
          <text x="800" y="474" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB">25% hearing-aid compatible</text>
          <text x="800" y="484" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB">75% standard earbuds</text>

          {/* Signage */}
          <rect x="60" y="440" width="120" height="50" rx="8" fill="#7C3AED" opacity="0.05" stroke="#7C3AED" strokeWidth="1" />
          <text x="120" y="460" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#7C3AED" fontWeight="600">POSTED SIGNAGE</text>
          <text x="120" y="474" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED">International Symbol of</text>
          <text x="120" y="484" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED">Access for Hearing Loss</text>

          {/* Hearing aid icon */}
          <circle cx="320" cy="310" r="10" fill="#C2410C" opacity="0.08" stroke="#C2410C" strokeWidth="1" />
          <text x="320" y="314" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#C2410C">T</text>
          <text x="340" y="314" fontFamily="Manrope, sans-serif" fontSize="6" fill="#C2410C">T-coil</text>

          {/* Headphone icon */}
          <circle cx="520" cy="310" r="10" fill="#2563EB" opacity="0.08" stroke="#2563EB" strokeWidth="1" />
          <text x="520" y="314" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB">🎧</text>
          <text x="540" y="314" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB">Receiver</text>
      ...
      <style>{`@keyframes alsFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}