...
export default function AssistiveListeningDiagram() {
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: '0 0 8px' }}>§706 Assistive Listening Systems</h3>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', animation: 'alsFade .25s ease-out' }}>
