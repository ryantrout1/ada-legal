...
export default function KneeToeDiagram() {
  ...
  return (
    <div style={{ margin: '32px 0' }}>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: '12px', background: 'white', border: '1px solid var(--slate-200)', borderRadius: '12px', overflow: 'hidden', animation: 'kneeFade 0.25s ease-out' }}>
