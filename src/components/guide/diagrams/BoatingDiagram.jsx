    ...
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="bt-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="450" y="28" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="10" fontWeight="700" fill="var(--body-secondary)" letterSpacing=".08em">ACCESSIBLE BOAT SLIP & BOARDING PIER</text>
          ...
          <text x="100" y="90" fontFamily="Manrope, sans-serif" fontSize="9" fill="var(--body-secondary)" fontWeight="500">SHORE / PARKING</text>
          ...
          <text x="450" y="325" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="var(--body-secondary)" fontWeight="600">FLOATING PIER</text>
          ...
          <text x="180" y="440" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="var(--body-secondary)">BOAT</text>
          ...
          <text x="420" y="440" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="var(--body-secondary)">BOAT</text>
