  ...
  return (
    <div style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--slate-900)', margin: 0 }}>§1003 Recreational Boating Facilities</h3>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="bt-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="450" y="480" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="12" fill="#2563EB" opacity="0.2" fontWeight="700">WATER</text>
          ...
          <text x="210" y="215" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB" fontWeight="600" transform="rotate(-90,210,215)">GANGWAY</text>
          <text x="250" y="200" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB">1:12 max</text>
          <text x="250" y="212" fontFamily="Manrope, sans-serif" fontSize="6" fill="#2563EB">(1:8 if &gt;80ft)</text>

          {/* Transition plate */}
          <rect x="180" y="275" width="60" height="16" rx="2" fill="#7C3AED" opacity="0.1" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="210" y="286" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="5.5" fill="#7C3AED" fontWeight="600">TRANSITION</text>
          <text x="280" y="286" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED">{d('36', '915')} wide min</text>
          ...
          <text x="180" y="375" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#C2410C" fontWeight="600">ACCESSIBLE SLIP</text>
          {/* Clear pier space */}
          ...
          <text x="690" y="364" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#16A34A" fontWeight="600">BOARDING PIER — {d('60', '1525')} wide min</text>
          {/* Launch ramp */}
          <rect x="600" y="375" width="180" height="110" rx="4" fill="#16A34A" opacity="0.03" stroke="#16A34A" strokeWidth="1" strokeDasharray="4 2" />
          <text x="690" y="435" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#16A34A">LAUNCH AREA</text>
          ...
          <text x="210" y="125" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED" fontWeight="600">Accessible Route</text>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden', animation: 'btFade .25s ease-out' }}>
      ...
      <style>{`@keyframes btFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}