    ...
    <div style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="ar-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="250" y="185" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#2563EB" fontWeight="600">LOADING / UNLOADING PLATFORM</text>

          {/* Level surface */}
          <rect x="100" y="220" width="200" height="200" rx="4" fill="#2563EB" opacity="0.04" stroke="#2563EB" strokeWidth="1" strokeDasharray="4 3" />
          <text x="200" y="325" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#2563EB">{d('60', '1525')} × {d('60', '1525')} min</text>
          <text x="200" y="340" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#2563EB">Level surface</text>
          ...
          <text x="120" y="100" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#7C3AED" fontWeight="600">QUEUE</text>
          <text x="120" y="115" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED">(accessible route)</text>
          ...
          <text x="370" y="232" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#D97706" fontWeight="600">ACCESS TYPE</text>
          <text x="370" y="244" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#D97706">SIGNAGE</text>
          ...
          <text x="590" y="310" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#C2410C" fontWeight="600">WHEELCHAIR</text>
          <text x="590" y="325" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="8" fill="#C2410C" fontWeight="600">SPACE</text>
          <text x="590" y="345" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#C2410C">{d('36', '915')} × {d('48', '1220')} min</text>

          {/* Transfer seat */}
          <rect x="700" y="260" width="120" height="100" rx="6" fill="#16A34A" opacity="0.05" stroke="#16A34A" strokeWidth="1.5" />
          <text x="760" y="305" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#16A34A" fontWeight="600">TRANSFER SEAT</text>
          <text x="760" y="320" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#16A34A">{d('24', '610')} w × {d('21', '535')} d</text>
          <text x="760" y="335" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#16A34A">14–17" height</text>
          {/* Transfer supports */}
          ...
          <text x="760" y="355" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="5" fill="#16A34A">← supports →</text>
      ...
      <style>{`@keyframes arFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}