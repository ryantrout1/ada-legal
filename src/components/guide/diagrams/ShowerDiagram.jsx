...
const CALLOUTS = [
  { id: 1, label: 'Transfer vs Roll-In', section: '\u00a7608.2', color: '#C2410C', textColor: '#7C2D12', x: 170, y: 52, plain: 'Transfer showers are 36\u00d736 inches \u2014 the user transfers from a wheelchair onto a built-in seat. Roll-in showers are 60\u00d730 inches (standard) or 36\u00d760 inches (alternate) \u2014 a wheelchair can roll directly in. Roll-in showers have no curb (\u00bd inch max threshold). Transfer showers have a folding or fixed seat. Both types need 30\u00d748 inch clear floor space outside the shower.', legal: 'Transfer: \u201C36\u00d736 inches clear inside dimensions.\u201D Standard roll-in: \u201C30\u00d760 inches minimum.\u201D Alternate roll-in: \u201C36\u00d760 inches.\u201D Threshold: \u201C\u00bd inch maximum.\u201D', citation: '\u00a7608.2.1, \u00a7608.2.2, \u00a7608.7' },
  { id: 2, label: 'Grab Bars, Seat & Controls', section: '\u00a7608.3', color: '#15803D', textColor: '#14532D', x: 540, y: 52, plain: 'Transfer showers need grab bars across the back wall and side wall opposite the seat. Roll-in showers need bars on three walls. Seats: transfer type needs a folding seat 17\u201319 inches high. Controls must be between 38 and 48 inches above the shower floor, operable with one hand. A hand-held shower spray with 59-inch hose is required for all types. No shower enclosures that obstruct controls or transfer.', legal: 'Grab bars per \u00a7608.3. Seats per \u00a7608.4. Controls: \u201C38 inches minimum and 48 inches maximum above the shower floor.\u201D Spray: \u201CA shower spray unit with a hose 59 inches long minimum.\u201D', citation: '\u00a7608.3, \u00a7608.4, \u00a7608.5, \u00a7608.6' }
];
