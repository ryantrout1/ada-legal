...
const CALLOUTS = [
  { id: 1, label: 'Cab Size', section: '§407.4.1', color: '#C2410C', x: 100, y: 42,
  ...
  { id: 2, label: 'Door Width', section: '§407.4.3', color: '#16A34A', x: 300, y: 42,
  ...
  { id: 3, label: 'Door Timing', section: '§407.3.4', color: '#2563EB', x: 500, y: 42,
  ...
  { id: 4, label: 'Controls Inside', section: '§407.4.7', color: '#7C3AED', x: 100, y: 260,
  ...
  { id: 5, label: 'Hall Calls Outside', section: '§407.2.1', color: '#D97706', x: 300, y: 260,
  ...
  { id: 6, label: 'Hall Signals', section: '§407.2.2', color: '#DB2777', x: 500, y: 260,
  ...
  { id: 7, label: 'Floor Designation', section: '§407.4.7.1', color: '#0EA5E9', x: 700, y: 150,
...
function makeLink(t) { return (<a href={ELV_URL} target="_blank" rel="noopener noreferrer" style={{ color: '#C2410C', textDecoration: 'none', borderBottom: '1px dotted #C2410C' }}>{t}<span aria-hidden="true" style={{ fontSize: '.65em', marginLeft: 1, verticalAlign: 'super' }}>↗</span></a>); }
    ...
    <div style={{ margin: '32px 0' }}>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 420" role="img" aria-labelledby="elv-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="210" y="38" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#16A34A" fontWeight="600">DOOR ({d('42', '1065')} center)</text>
          {/* Cab width */}
          ...
          <text x="210" y="285" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6" fill="#7C3AED">Turning space</text>
          {/* Control panel location */}
          <rect x="330" y="80" width="24" height="100" rx="2" fill="#7C3AED" opacity="0.1" stroke="#7C3AED" strokeWidth="1" />
          <text x="342" y="140" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="5" fill="#7C3AED" fontWeight="600" transform="rotate(-90 342 140)">PANEL</text>
          ...
          {/* Star on floor 1 */}
          <text x="618" y="308" fontFamily="Manrope, sans-serif" fontSize="10" fill="#D97706">★</text>
          {/* Reach range zone */}
          ...
          <text x="540" y="278" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#D97706" fontWeight="600">Hall calls</text>
          <text x="540" y="290" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#D97706">≤ {d('42', '1065')}</text>

          {/* Floor jamb designation */}
          <rect x="790" y="120" width="90" height="55" rx="6" fill="#0EA5E9" opacity="0.04" stroke="#0EA5E9" strokeWidth="1" />
          <text x="835" y="140" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#0EA5E9" fontWeight="600">JAMB SIGNS</text>
          <text x="835" y="153" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#0EA5E9">Both sides, {d('48', '1220')}</text>
          <text x="835" y="165" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="6.5" fill="#0EA5E9">{d('2', '51')} high min</text>
      ...
      <style>{`@keyframes elvFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}