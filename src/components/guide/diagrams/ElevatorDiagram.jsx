...
const CALLOUTS = [
  { id: 1, label: 'Cab Size', section: '§407.4.1', color: 'var(--section-label)', textColor: '#8B2E08', x: 100, y: 42,
  ...
  { id: 2, label: 'Door Width', section: '§407.4.3', color: '#15803D', textColor: '#14532D', x: 300, y: 42,
  ...
  { id: 5, label: 'Hall Calls Outside', section: '§407.2.1', color: '#92400E', textColor: '#78350F', x: 300, y: 260,
  ...
  { id: 6, label: 'Hall Signals', section: '§407.2.2', color: '#BE185D', textColor: '#9D174D', x: 500, y: 260,
  ...
  { id: 7, label: 'Floor Designation', section: '§407.4.7.1', color: '#0E7490', textColor: '#0C4A6E', x: 700, y: 150,
...
function makeLink(t) { return (<a href={ELV_URL} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--section-label)', textColor: '#8B2E08', textDecoration: 'none', borderBottom: '1px dotted var(--accent)' }}>{t}<span aria-hidden="true" style={{ fontSize: '.65em', marginLeft: 1, verticalAlign: 'super' }}>↗</span></a>); }
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--heading)', margin: 0 }}>§407 Elevators</h3>
      ...
      <div style={{ background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 420" role="img" aria-labelledby="elv-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          {/* LEFT: Cab Plan View */}
          <text x="210" y="24" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="10" fontWeight="700" fill="var(--body-secondary)" letterSpacing=".08em">PLAN VIEW — ELEVATOR CAB</text>
          {/* Cab walls */}
          <rect x="60" y="50" width="300" height="320" rx="4" fill="white" stroke="#94A3B8" strokeWidth="2.5" />
          {/* Door opening (center) */}
          <rect x="135" y="46" width="150" height="8" rx="0" fill="var(--page-bg-subtle)" stroke="none" />
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'var(--card-bg)', border: '1px solid var(--border)', borderRadius: 12, overflow: 'hidden', animation: 'elvFade .25s ease-out' }}>
