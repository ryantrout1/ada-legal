...
export default function HandrailDiagram() {
  ...
  return (
    <div className="ada-diagram-wrap" style={{ margin: '48px 0 32px' }}>
      ...
      {activeCallout && (
        <div ref={panelRef} style={{ marginTop: '12px', background: 'white', border: '1px solid var(--slate-200)', borderRadius: '12px', overflow: 'hidden', animation: 'railFade 0.25s ease-out' }}>
