  ...
  return (
    <div style={{ margin: '32px 0' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8, flexWrap: 'wrap', gap: 8 }}>
        <h3 style={{ fontFamily: 'Fraunces, serif', fontSize: '1.15rem', fontWeight: 700, color: 'var(--slate-900)', margin: 0 }}>§704 Telephones</h3>
      ...
      <div style={{ background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden' }}>
        <svg viewBox="0 0 900 520" role="img" aria-labelledby="tel-title" style={{ width: '100%', height: 'auto', display: 'block' }}>
          ...
          <text x="265" y="270" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="5" fill="#2563EB" fontWeight="600">VOL</text>

          {/* Cord */}
          <path d="M220,230 Q180,290 210,320" fill="none" stroke="#D97706" strokeWidth="1.5" strokeDasharray="3 2" />
          <text x="175" y="290" fontFamily="Manrope, sans-serif" fontSize="6" fill="#D97706" fontWeight="600">{d('29', '735')} min</text>

          {/* TTY shelf */}
          <rect x="170" y="330" width="160" height="10" rx="2" fill="#7C3AED" opacity="0.1" stroke="#7C3AED" strokeWidth="1.5" />
          <text x="250" y="355" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7" fill="#7C3AED" fontWeight="600">TTY SHELF</text>
          ...
          <text x="680" y="265" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#C2410C" fontWeight="600">CLEAR FLOOR</text>
          <text x="680" y="278" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="9" fill="#C2410C" fontWeight="600">SPACE</text>
          ...
          <text x="680" y="155" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="5.5" fill="#7C3AED" fontWeight="600">SHELF: {d('10', '255')}×{d('10', '255')} min</text>

          {/* Volume note */}
          <rect x="520" y="430" width="320" height="30" rx="6" fill="#2563EB" opacity="0.05" stroke="#2563EB" strokeWidth="1" />
          <text x="680" y="449" textAnchor="middle" fontFamily="Manrope, sans-serif" fontSize="7.5" fill="#2563EB" fontWeight="600">Volume: 12 dB min gain · 18 dB on at least one per floor</text>
      ...
      {ac && (
        <div ref={panelRef} style={{ marginTop: 12, background: 'white', border: '1px solid var(--slate-200)', borderRadius: 12, overflow: 'hidden', animation: 'telFade .25s ease-out' }}>
      ...
      <style>{`@keyframes telFade{from{opacity:0;transform:translateY(-8px)}to{opacity:1;transform:translateY(0)}}`}</style>
    </div>
  );
}