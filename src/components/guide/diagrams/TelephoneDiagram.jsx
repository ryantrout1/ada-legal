...
const CALLOUTS = [
  ...
  { id: 5, label: 'Cord Length', section: '§704.3', color: '#D97706', textColor: '#78350F', x: 350, y: 340, plain: 'The telephone handset cord must be at least 29 inches long so a seated user can reach it comfortably. This allows someone in a wheelchair to hold the phone while positioned at the clear floor space.', legal: '"The cord from the telephone to the handset shall be 29 inches long minimum."', citation: '§704.3' }
];
