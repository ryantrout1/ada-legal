  ...
  return (
    <div id={id}>
      <button type="button" onClick={toggle} aria-expanded={!collapsed} style={{
        ...
        {collapsed
          ? <ChevronRight size={15} style={{ color: 'var(--slate-500)', flexShrink: 0 }} />
          : <ChevronDown size={15} style={{ color: 'var(--slate-500)', flexShrink: 0 }} />
        }
        ...
        {count !== undefined && (
          <span style={{
            ...
            color: iconColor || 'var(--slate-500)', backgroundColor: 'var(--slate-100)',
