    ...
    >
      ...
      {overdueContacts.length === 0 ? (
        <div style={{ padding: '16px 12px', textAlign: 'center' }}>
          <p style={{ fontFamily: 'Manrope, sans-serif', fontSize: '0.8125rem', color: 'var(--suc-fg)', margin: 0, fontWeight: 600 }}>
          ...
          {overdueContacts.map((item, i) => (
            <div
              ...
              style={{
                ...
                padding: '8px 12px',
                borderBottom: i < overdueContacts.length - 1 ? '1px solid var(--card-bg-tinted)' : 'none',
            ...
            >
              <div style={{ flex: '1 1 auto', minWidth: 0 }}>
                <p style={{
                  ...
                  {item.lawyerName} <span style={{ fontWeight: 400, color: 'var(--body-secondary)' }}>→ {item.caseName}</span>
                </p>
                <p style={{
                  fontFamily: 'Manrope, sans-serif', fontSize: '0.6875rem', fontWeight: 700,
                  color: 'var(--err-fg)', margin: '1px 0 0',
                }}>
