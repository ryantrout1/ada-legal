        ...
        <div style={{
          ...
          {[
            ...
            <div key={i} style={{ textAlign: 'center', flex: '1 1 0' }}>
              <p style={{ fontFamily: 'Manrope, sans-serif', fontSize: '0.6875rem', fontWeight: 600, color: 'var(--body-secondary)', textTransform: 'uppercase', letterSpacing: '0.04em', margin: '0 0 2px' }}>
                {s.label}
              </p>
