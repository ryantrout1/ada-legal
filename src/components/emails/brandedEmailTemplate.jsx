    ...
    <div style="background-color: #1E293B; padding: 24px 32px; text-align: center;">
      <table role="presentation" style="margin: 0 auto;"><tr>
        <td style="vertical-align: middle; padding-right: 10px;">
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/6994acc34810e36068eddec2/2b7a73622_image11.png" alt="ADA Legal Link" width="32" height="32" style="display: block;" />
        </td>
