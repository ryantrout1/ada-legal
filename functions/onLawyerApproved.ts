...
<div style="max-width:600px;margin:0 auto;">
  ...
  <div style="background-color:#fff;padding:40px 32px;border-left:1px solid #E2E8F0;border-right:1px solid #E2E8F0;">
    <h1 style="font-family:Georgia,serif;font-size:24px;font-weight:700;color:#15803D;margin:0 0 24px 0;">Welcome to ADA Legal Marketplace</h1>
    <div style="font-size:15px;line-height:1.7;">
      <p>Dear ${data.full_name},</p>
      <p>Congratulations — your attorney account has been <strong>approved</strong>! You are now eligible to access the ADA Legal Marketplace and initiate support for ADA violation cases in your licensed states.</p>
  ...
  <div style="background-color:#1E293B;padding:20px 32px;text-align:center;">
    ...
    await base44.asServiceRole.integrations.Core.SendEmail({
      to: data.email,
      subject: 'Welcome to ADA Legal Marketplace',
      body: emailHtml
    });
